...
$bts->I18nTransObj->apply(
	array(
		...
		"fra" => array(
			...
			<br>\r
			Mais il y avait une lueur d'espoir. Alors… Travailler là-dessus était un pari risqué. Cependant… J'ai pu récupérer des données depuis lesquelles je pouvais redémarrer. Janus Engine rentrait dans la salle d'opération. <br>\r
			<br>\r
			...
			<br>\r
			Donc &laquo; ouais &raquo; Janus Engine est revenu de l'enfer.<br>\r
		...
		"eng" => array(
			...
			But there was hope. So… Working on it was kind of a bet. Still… I could manage to recover some data from which I could start again. Janus Engine was in the surgery room. <br>\r<br>\r
			...
			So yes Janus Engine is back from hell.<br>\r<br>\r
			<br>\r	<br>\r	<br>\r	<br>\r	<br>\r
			<br>\r	<br>\r	<br>\r	<br>\r	<br>\r
			<br>\r	<br>\r	<br>\r	<br>\r	<br>\r
		")

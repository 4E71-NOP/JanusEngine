...
$Content .= "Type: KeyWord<br>\r<br>\r";
...
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getKeyWord());


$obj->setKeyWordEntry('keyword_name', $obj->getKeyWordEntry('keyword_name')."*");
$obj->sendToDB();
$obj->getDataFromDB($id);
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getKeyWord());

...
$Content .= "Type: Language<br>\r<br>\r";
...
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getLanguage());


$obj->setLanguageEntry('lang_original_name', $obj->getLanguageEntry('lang_original_name')."*");
$obj->sendToDB();
$obj->getDataFromDB($id);
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getLanguage());

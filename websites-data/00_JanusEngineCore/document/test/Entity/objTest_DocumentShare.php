...
$obj = new DocumentShare();
$id = 100;

$obj->getDataFromDB($id);

$Content .= "Type: DocumentShare<br>\r<br>\r";
...
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getDocumentShare());


$obj->setDocumentShareEntry('share_name', $obj->getDocumentShareEntry('share_name')."*");
$obj->sendToDB();
$obj->getDataFromDB($id);
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getDocumentShare());

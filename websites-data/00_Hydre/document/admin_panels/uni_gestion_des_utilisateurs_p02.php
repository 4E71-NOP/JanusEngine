...
$RequestDataObj->setRequestData('userForm',
		array(
				'mode'			=> 'edit',
// 				'mode'			=> 'create',
				'selectionId'	=>	30,
...
/*Hydre-contenu_debut*/
$localisation = " / fra_gestion_des_utilisateurs_p02";
$MapperObj->AddAnotherLevel($localisation );
$LMObj->logCheckpoint("fra_gestion_des_utilisateurs_p02");
$MapperObj->RemoveThisLevel($localisation );
$MapperObj->setSqlApplicant("fra_gestion_des_utilisateurs_p02");
...
switch ( $RequestDataObj->getRequestDataSubEntry('userForm', 'mode') ) {
	case "edit":
		$commandType = "update";
...
$T['AD'][$curTab]['6']['1']['cont'] = $I18nObj->getI18nEntry('t1l6c1');
...
$T['AD'][$curTab]['1']['1']['cont'] = $I18nObj->getI18nEntry('t2l1c1');
$T['AD'][$curTab]['2']['1']['cont'] = $I18nObj->getI18nEntry('t2l2c1');
$T['AD'][$curTab]['3']['1']['cont'] = $I18nObj->getI18nEntry('t2l3c1');
$T['AD'][$curTab]['4']['1']['cont'] = $I18nObj->getI18nEntry('t2l4c1');
...
// --------------------------------------------------------------------------------------------
$curTab++;
$T['AD'][$curTab]['1']['1']['cont'] = $I18nObj->getI18nEntry('t3l1c1');
$T['AD'][$curTab]['2']['1']['cont'] = $I18nObj->getI18nEntry('t3l2c1');
$T['AD'][$curTab]['3']['1']['cont'] = $I18nObj->getI18nEntry('t3l3c1');
$T['AD'][$curTab]['4']['1']['cont'] = $I18nObj->getI18nEntry('t3l4c1');
$T['AD'][$curTab]['5']['1']['cont'] = $I18nObj->getI18nEntry('t3l5c1');
$T['AD'][$curTab]['6']['1']['cont'] = $I18nObj->getI18nEntry('t3l6c1');
...
$T['AD'][$curTab]['1']['1']['cont'] = $I18nObj->getI18nEntry('t4l1c1');
$T['AD'][$curTab]['2']['1']['cont'] = $I18nObj->getI18nEntry('t4l2c1');
$T['AD'][$curTab]['3']['1']['cont'] = $I18nObj->getI18nEntry('t4l3c1');
$T['AD'][$curTab]['4']['1']['cont'] = $I18nObj->getI18nEntry('t4l4c1');
$T['AD'][$curTab]['5']['1']['cont'] = $I18nObj->getI18nEntry('t4l5c1');
...
$T['AD'][$curTab]['1']['1']['cont'] = $I18nObj->getI18nEntry('t5l1c1');
$T['AD'][$curTab]['2']['1']['cont'] = $I18nObj->getI18nEntry('t5l2c1');
$T['AD'][$curTab]['3']['1']['cont'] = $I18nObj->getI18nEntry('t5l3c1');
$T['AD'][$curTab]['4']['1']['cont'] = $I18nObj->getI18nEntry('t5l4c1');
...
$T['AD'][$curTab]['6']['1']['cont'] = $I18nObj->getI18nEntry('t6l6c1');
$T['AD'][$curTab]['7']['1']['cont'] = $I18nObj->getI18nEntry('t6l7c1');
$T['AD'][$curTab]['8']['1']['cont'] = $I18nObj->getI18nEntry('t6l8c1');
$T['AD'][$curTab]['9']['1']['cont'] = $I18nObj->getI18nEntry('t6l9c1');
...
//
// --------------------------------------------------------------------------------------------
$T['tab_infos'] = $RenderTablesObj->getDefaultDocumentConfig($infos, 10, 6);
$T['ADC']['onglet'] = array(
		1	=>	$RenderTablesObj->getDefaultTableConfig(5,2,2),
		2	=>	$RenderTablesObj->getDefaultTableConfig(4,2,2),
		3	=>	$RenderTablesObj->getDefaultTableConfig(6,2,2),
		4	=>	$RenderTablesObj->getDefaultTableConfig(5,2,2),
		5	=>	$RenderTablesObj->getDefaultTableConfig(4,2,2),
		6	=>	$RenderTablesObj->getDefaultTableConfig(9,2,2),
);

...
$RequestDataObj->setRequestData('themeForm',
		array(
				'mode'			=> 'edit',
// 				'mode'			=> 'create',
				'selectionId'	=>	30,
...
$CMObj->setConfigurationEntry('colorSelector', 'system');		//"or Hydr"


/*Hydre-contenu_debut*/
$localisation = " / uni_gestion_des_themes_p02";
$MapperObj->AddAnotherLevel($localisation );
$LMObj->logCheckpoint("uni_gestion_des_themes_p02");
$MapperObj->RemoveThisLevel($localisation );
$MapperObj->setSqlApplicant("uni_gestion_des_themes_p02");
...
switch ( $RequestDataObj->getRequestDataSubEntry('themeForm', 'mode') ) {
	case "edit":
		$commandType = "update";
	...
	case "create":
		...
		$t1l3c2 = "<input type='text' name='formParams[title]' size='45' maxlength='255' value=\"".$I18nObj->getI18nEntry('t1l2c2')."\" class='".$Block."_t3 ".$Block."_form_1'>\r";
...
$T['AD'][$curTab]['1']['1']['cont'] = $I18nObj->getI18nEntry('t1l1c1');
$T['AD'][$curTab]['2']['1']['cont'] = $I18nObj->getI18nEntry('t1l2c1');
$T['AD'][$curTab]['3']['1']['cont'] = $I18nObj->getI18nEntry('t1l3c1');
$T['AD'][$curTab]['4']['1']['cont'] = $I18nObj->getI18nEntry('t1l4c1');
$T['AD'][$curTab]['5']['1']['cont'] = $I18nObj->getI18nEntry('t1l5c1');
...
for ( $i = 2 ; $i <= 3 ; $i++ ) {
	for ( $j = 1 ; $j <= 15 ; $j++ ) {
		...
		$T['AD'][$i][$j]['1']['cont'] = $I18nObj->getI18nEntry('t2lxc1') . "_" . $decoCount2;
		$T['AD'][$i][$j]['2']['cont'] = "
...
for ( $j = 1 ; $j <= 30 ; $j++ ) {
	$decoCount2 = sprintf("%02u", $decoCount1 );
	$T['AD']['4'][$j]['1']['cont'] = $I18nObj->getI18nEntry('t2lxc1') . "_" . $decoCount2;
...
// --------------------------------------------------------------------------------------------
$curTab = 5;
$T['AD'][$curTab]['1']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l1c1');
$T['AD'][$curTab]['2']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l2c1')." #1";
$T['AD'][$curTab]['3']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l2c1')." #2";
$T['AD'][$curTab]['4']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l2c1')." #3";
$T['AD'][$curTab]['5']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l2c1')." #4";
$T['AD'][$curTab]['6']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l2c1')." #5";
$T['AD'][$curTab]['7']['2']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l7c1');
$T['AD'][$curTab]['7']['1']['colspan']		= 2;
$T['AD'][$curTab]['8']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l8c1');
$T['AD'][$curTab]['9']['1']['cont']			= $I18nObj->getI18nEntry('t'.$curTab.'l9c1');
$T['AD'][$curTab]['10']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l10c1');
$T['AD'][$curTab]['11']['2']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l11c1');
$T['AD'][$curTab]['11']['1']['colspan']		= 2;
$T['AD'][$curTab]['12']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l12c1');
$T['AD'][$curTab]['13']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l13c1');
$T['AD'][$curTab]['14']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l14c1');
$T['AD'][$curTab]['15']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l15c1');
$T['AD'][$curTab]['16']['2']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l16c1');
$T['AD'][$curTab]['16']['1']['colspan']		= 2;
$T['AD'][$curTab]['17']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l17c1');
$T['AD'][$curTab]['18']['1']['cont']		= $I18nObj->getI18nEntry('t'.$curTab.'l18c1');
...
$T['AD'][$curTab]['1']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['2']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['3']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['5']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['6']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['8']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['12']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['17']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);
...
$CurrentSetObj->setDataSubEntry('fs', $CurrentSetObj->getDataEntry('fsIdx'),$FileSelectorConfig);
$CurrentSetObj->setDataEntry('fsIdx', $CurrentSetObj->getDataEntry('fsIdx')+1 );
$T['AD'][$curTab]['18']['2']['cont']		= $InteractiveElementsObj->renderIconSelectFile($infos);



// --------------------------------------------------------------------------------------------
$curTab++;
$T['AD'][$curTab]['1']['1']['cont'] = $I18nObj->getI18nEntry('t6l1c1');
$T['AD'][$curTab]['2']['1']['cont'] = $I18nObj->getI18nEntry('t6l2c1');
$T['AD'][$curTab]['3']['1']['cont'] = $I18nObj->getI18nEntry('t6l3c1');
$T['AD'][$curTab]['4']['1']['cont'] = $I18nObj->getI18nEntry('t6l4c1');
$T['AD'][$curTab]['5']['1']['cont'] = $I18nObj->getI18nEntry('t6l5c1');
$T['AD'][$curTab]['6']['2']['cont'] = $I18nObj->getI18nEntry('t6l6c1');
...
<option value='1' ".$admctrl_position['1']."> ".$I18nObj->getI18nEntry('acpUp')." - ".		$I18nObj->getI18nEntry('acpLeft')		." </option>\r
<option value='2' ".$admctrl_position['2']."> ".$I18nObj->getI18nEntry('acpUp')." - ".		$I18nObj->getI18nEntry('acpMiddle')	." </option>\r
<option value='3' ".$admctrl_position['3']."> ".$I18nObj->getI18nEntry('acpUp')." - ".		$I18nObj->getI18nEntry('acpRight')	." </option>\r
<option value='4' ".$admctrl_position['4']."> ".$I18nObj->getI18nEntry('acpMiddle')." - ".	$I18nObj->getI18nEntry('acpRight')	." </option>\r
<option value='5' ".$admctrl_position['5']."> ".$I18nObj->getI18nEntry('acpDown')." - ".		$I18nObj->getI18nEntry('acpRight')	." </option>\r
<option value='6' ".$admctrl_position['6']."> ".$I18nObj->getI18nEntry('acpDown')." - ".		$I18nObj->getI18nEntry('acpMiddle')	." </option>\r
<option value='7' ".$admctrl_position['7']."> ".$I18nObj->getI18nEntry('acpDown')." - ".		$I18nObj->getI18nEntry('acpLeft')		." </option>\r
<option value='8' ".$admctrl_position['8']."> ".$I18nObj->getI18nEntry('acpMiddle')." - ".	$I18nObj->getI18nEntry('acpLeft')		." </option>\r
</select>\r";
...
//
// --------------------------------------------------------------------------------------------
$T['tab_infos'] = $RenderTablesObj->getDefaultDocumentConfig($infos, 16, 6);
$T['ADC']['onglet'] = array(
		1	=>	$RenderTablesObj->getDefaultTableConfig(4,2,2),
		2	=>	$RenderTablesObj->getDefaultTableConfig(15,2,2),
		3	=>	$RenderTablesObj->getDefaultTableConfig(15,2,2),
		4	=>	$RenderTablesObj->getDefaultTableConfig(10,2,2),
		5	=>	$RenderTablesObj->getDefaultTableConfig(18,2,2),
		6	=>	$RenderTablesObj->getDefaultTableConfig(6,2,2),
);

...
// --------------------------------------------------------------------------------------------
/*Hydre-contenu_debut*/
$localisation = " / uni_test_d_article_p01.php";
$MapperObj->AddAnotherLevel($localisation );
$LMObj->logCheckpoint("uni_test_d_article_p01.php");
$MapperObj->RemoveThisLevel($localisation );
$MapperObj->setSqlApplicant("uni_test_d_article_p01.php");

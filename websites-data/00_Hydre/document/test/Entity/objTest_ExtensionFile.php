...
$ClassLoaderObj->provisionClass ( 'ExtensionFile' );
$obj = new ExtensionFile();
$id = 1;

$obj->getDataFromDB($id);

$Content .= "Type: ExtensionFile<br>\r<br>\r";
...
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getExtensionFile());


$obj->setExtensionFileEntry('extension_name', $obj->getExtensionFileEntry('extension_name')."*");
$obj->sendToDB();
$obj->getDataFromDB($id);
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getExtensionFile());

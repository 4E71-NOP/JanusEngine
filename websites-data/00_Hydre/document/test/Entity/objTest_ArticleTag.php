...
$ClassLoaderObj->provisionClass ( 'ArticleTag' );
$obj = new ArticleTag();
$id = 10;

$obj->getDataFromDB($id);

$Content .= "Type: ArticleTag<br>\r<br>\r";
...
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getArticleTag());


$obj->setArticleTagEntry('keyword_name', $obj->getArticleTagEntry('keyword_name')."*");
$obj->sendToDB();
$obj->getDataFromDB($id);
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getArticleTag());

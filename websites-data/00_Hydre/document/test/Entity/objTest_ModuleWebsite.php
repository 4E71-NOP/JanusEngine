...
$obj = new ModuleWebsite();
$id = 1;

$obj->getDataFromDB($id);

$Content .= "Type: ModuleWebsite<br>\r<br>\r";
...
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getModuleWebsite());


$obj->setModuleWebsiteEntry('ModuleWebsite_name', $obj->getModuleWebsiteEntry('ModuleWebsite_name')."*");
$obj->sendToDB();
$obj->getDataFromDB($id);
$Content .= "<br>\r";
$Content .= $bts->StringFormatObj->print_r_html($obj->getModuleWebsite());

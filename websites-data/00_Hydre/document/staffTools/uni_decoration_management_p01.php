...
$cs->LMObj->logCheckpoint("uni_decoration_management_p01.php");
$cs->MapperObj->RemoveThisLevel($localisation );
$cs->MapperObj->setSqlApplicant("uni_decoration_management_p01.php");
...
if ( $cs->SDDMObj->num_row_sql($dbquery) == 0 ) {
	...
	while ($dbp = $cs->SDDMObj->fetch_array_sql($dbquery)) { 
		...
		."'>".$dbp['deco_name']."</a>";
		$T['AD']['1'][$i]['2']['cont']	= $cs->I18nObj->getI18nEntry('state')[$dbp['deco_state']];
		$T['AD']['1'][$i]['3']['cont']	= $cs->I18nObj->getI18nEntry('type')[$dbp['deco_type']];
	}
}

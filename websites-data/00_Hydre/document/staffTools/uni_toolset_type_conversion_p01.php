...
$cs->RequestDataObj->setRequestData('CONV',
	array(
		'src'		=> 0,
		'dst'		=> 0,
...
$cs->LMObj->logCheckpoint("uni_toolset_type_conversion_p01.php");
$cs->MapperObj->RemoveThisLevel($localisation );
$cs->MapperObj->setSqlApplicant("uni_toolset_type_conversion_p01.php");
...
$cs->GeneratedJavaScriptObj->insertJavaScript('File', 'engine/javascript/lib_ConvertTool.js');
...
$select_type = array();
$select_type['0']['t'] = $cs->I18nObj->getI18nEntry('TypeTxt');	$select_type['0']['s'] = "";	$select_type['0']['db'] = "0";
$select_type['1']['t'] = $cs->I18nObj->getI18nEntry('TypeHtml');	$select_type['1']['s'] = "";	$select_type['1']['db'] = "1";
$select_type['2']['t'] = $cs->I18nObj->getI18nEntry('TypeMixed');	$select_type['2']['s'] = "";	$select_type['2']['db'] = "2";
$select_type['3']['t'] = $cs->I18nObj->getI18nEntry('TypePHP');	$select_type['3']['s'] = "";	$select_type['3']['db'] = "3";
$select_type['4']['t'] = $cs->I18nObj->getI18nEntry('TypeHydr');	$select_type['4']['s'] = "";	$select_type['4']['db'] = "4";
...
<tr>\r
<td class='".$Block."_tb4 ".$Block."_fcta' style='text-align: center;'>\r".$cs->I18nObj->getI18nEntry('l1c1')."</td>\r
<td class='".$Block."_tb4 ".$Block."_fcta' style='text-align: center;'>\r".$cs->I18nObj->getI18nEntry('l1c2')."</td>\r
</tr>\r
...
".$cs->I18nObj->getI18nEntry('instruction')."<br>\r
...
".$cs->RequestDataObj->getRequestDataSubEntry('CONV', 'cont')."
</textarea>
</td>\r
</tr>\r
...
".
$cs->RequestDataObj->getRequestDataSubEntry('CONV', 'converti').
"</textarea>

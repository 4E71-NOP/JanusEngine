...
$bts->RequestDataObj->setRequestData('formGenericData',
	array(
		...
		'section'		=> 'AdminDocumentEditorP02',
		'creation'		=> 'on',
		'modification'	=> 'on',
		'deletion'		=> 'on',
		'mode'			=> 'edit',
...
$T['Content']['1']['5']['2']['cont'] = "<textarea style='width:98%; height:100%; min-width:512px; min-height:870px;'>".$currentDocumentObj->getDocumentEntry('docu_cont')."</textarea>";
...
//
// --------------------------------------------------------------------------------------------
$T['ContentInfos'] = $bts->RenderTablesObj->getDefaultDocumentConfig($infos, 41, 1);

...
$cs->LMObj->logCheckpoint("uni_article_management_p02.php");
$cs->MapperObj->RemoveThisLevel($localisation );
$cs->MapperObj->setSqlApplicant("uni_article_management_p02.php");
...
switch ($cs->RequestDataObj->getRequestDataSubEntry('formGenericData', 'mode')) {
	case "edit":
		...
		$currentArticleObj->getArticleDataFromDB(
			$cs->RequestDataObj->getRequestDataSubEntry('articleForm', 'selectionRef'),
			$cs->RequestDataObj->getRequestDataSubEntry('articleForm', 'selectionPage')
		);
	...
	case "create":
		...
		$d = date($cs->TimeObj->microtime_chrono());
...
$T['AD']['2']['2']['2']['cont'] = $cs->TimeObj->timestampToDate($currentArticleObj->getArticleEntry('arti_creation_date'));
$T['AD']['2']['3']['2']['cont'] = $tabUser[$currentArticleObj->getArticleEntry('arti_creation_validateur')]['t'];
$T['AD']['2']['4']['2']['cont'] = $cs->TimeObj->timestampToDate($currentArticleObj->getArticleEntry('arti_validation_date'));
...
$T['AD']['2']['6']['2']['cont'] = $cs->TimeObj->timestampToDate($currentArticleObj->getArticleEntry('arti_release_date'));

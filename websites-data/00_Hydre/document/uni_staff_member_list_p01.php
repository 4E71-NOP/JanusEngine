...
foreach ( $user_liste as $B ) {
	if ( $B['group_id'] != $CurrentGroup ) {	
		...
		$DisplayGroupName = 1 ;
		$Content .= "<table class='".$Block._CLASS_TABLE01_."' ".$ThemeDataObj->getThemeDataEntry('tab_std_rules')." width='".$ThemeDataObj->getThemeDataEntry('theme_module_internal_width')."'>\r<tr>\r";

...
//		Creation de tag
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$R['tag_id']	= manipulation_trouve_id_suivant ( $SQL_tab_abrege['tag'] , "tag_id" );
				...
				$requete1 = "INSERT INTO ".$SQL_tab_abrege['tag']." VALUES ".$requete_valeurs.";";
...
//			echo ( "***R***<br>" . print_r_html ( $R ) . "<br>" );
			...
			if ( $R['ERR'] != 1 ) {
				$R['article_tag_id']	= manipulation_trouve_id_suivant ( $SQL_tab_abrege['article_tag'] , "article_tag_id" );

				$requete1 = "
				INSERT INTO ".$SQL_tab_abrege['article_tag']." VALUES ( 
				'".$R['article_tag_id']."', 
				'".$R['arti_id']."', 
				'".$R['tag_id']."' 
				);";
...
// --------------------------------------------------------------------------------------------
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				$R['tag_id']	= manipulation_trouve_id_suivant ( $SQL_tab_abrege['article_tag'] , "article_tag_id" );
				$requete1 = "
				DELETE FROM ".$SQL_tab_abrege['article_tag']." 

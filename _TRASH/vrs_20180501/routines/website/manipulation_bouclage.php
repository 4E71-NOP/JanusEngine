...
//	Creation de bouclage
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$R['id'] = manipulation_trouve_id_suivant ( $SQL_tab_abrege['bouclage'] , "bouclage_id" );
				...
				$requete1 = "INSERT INTO ".$SQL_tab_abrege['bouclage']." VALUES ".$requete_valeurs.";";
...
//	Modification de bouclage
		case 2:
			...
			if ( $R['ERR'] != 1 && $R['confirmation_modification'] != 0 ) {
				...
				$requete1 = "UPDATE ".$SQL_tab_abrege['bouclage']." SET ".$requete_colonne." WHERE bouclage_id = '".$R['id']."';";
				manipulation_traitement_requete ( $requete1 );
...
//	Suppression de bouclage
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				$requete1 = "UPDATE ".$SQL_tab_abrege['bouclage']." 

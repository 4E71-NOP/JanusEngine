...
function manipulation_module () {
	global $site_web, $SQL_tab, $SQL_tab_abrege, $MMster_install_script, $db;
	$R = &$_REQUEST['M_MODULE'];
...
//		Creation de module
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$R['id'] = manipulation_trouve_id_suivant ( $SQL_tab_abrege['module'] , "module_id" );
				unset ( $A );
				...
				$requete1 = "INSERT INTO ".$SQL_tab_abrege['module']." VALUES ".$requete_valeurs.";";

				$R['id2'] = manipulation_trouve_id_suivant ( $SQL_tab_abrege['site_module'] , "site_module_id" );
				$requete2 = "
				INSERT INTO ".$SQL_tab_abrege['site_module']." VALUES ( 
				'".$R['id2']."',
...
//		Modification de module
		case 2:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$requete1 = "UPDATE ".$SQL_tab_abrege['module']." SET ".$requete_colonne." WHERE module_id = '".$R['id']."';";

				$requete2 = "
				UPDATE ".$SQL_tab_abrege['site_module']." SET 
				module_etat			= '".$R['etat']."', 
...
//		Suppression de module
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				$requete1 = "
				UPDATE ".$SQL_tab_abrege['site_module']." 
				SET module_etat = '2', 
				module_position = '1' 
...
//		show
		case 5:
			...
			if ( $R['nom'] == "Nouveau module" ) {
				...
				FROM ".$SQL_tab_abrege['module']." as mdl , ".$SQL_tab_abrege['site_module']." as sm 

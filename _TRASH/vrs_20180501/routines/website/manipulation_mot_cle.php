...
function manipulation_mot_cle () {
	global $site_web, $SQL_tab, $SQL_tab_abrege, $master_install_script, $db;
	$R = &$_REQUEST['M_MOTCLE'];
...
//	Creation de mot cle
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$R['mc_id'] = manipulation_trouve_id_suivant ( $SQL_tab_abrege['mot_cle'] , "mc_id" );
				...
				$requete1 = "INSERT INTO ".$SQL_tab_abrege['mot_cle']." VALUES ".$requete_valeurs.";";
...
//	modification de mot cle
		case 2:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$requete1 = "UPDATE ".$SQL_tab_abrege['mot_cle']." SET ".$requete_colonne." WHERE mc_id = '".$R['id']."';";
				manipulation_traitement_requete ( $requete1 );
...
//	Suppression de categorie
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$requete1 = "UPDATE  ".$SQL_tab_abrege['mot_cle']." SET 
				mc_etat 		= '2' 
				WHERE mc_id	= '".$R['mc_id']."';";
				manipulation_traitement_requete ( $requete1 );

...
// 		$mod_auth_demande_connexion_resultat_test = "Connexion R&eacute;ussie";
		...
		if ( $SMObj->getSessionEntry('user_login') == "anonymous") {
			...
			<tr>\r<td class='".$ThemeDataObj->getThemeName().$infos['block']."_t3' style='text-align:center; padding-bottom:8px;'><input class='" . $ThemeDataObj->getThemeName().$infos['block']."_form_1 " . $ThemeDataObj->getThemeName().$infos['block']."_t3' type='text' name='form_user_login' size='16' maxlength='64' value='anonymous'></td>\r</tr>\r
			<tr>\r<td class='".$ThemeDataObj->getThemeName().$infos['block']."_t3' style='text-align:center;'>".$i18n['ps']."</td>\r</tr>\r
			<tr>\r<td class='".$ThemeDataObj->getThemeName().$infos['block']."_t3' style='text-align:center; padding-bottom:8px;'><input class='" . $ThemeDataObj->getThemeName().$infos['block']."_form_1 " . $ThemeDataObj->getThemeName().$infos['block']."_t3' type='password' name='form_user_password' size='16' maxlength='64' value='anonymous'></td>\r</tr>\r
			</table>\r".
			...
			<input type='hidden' name='formOrigin'		value='ModuleAuthentification'>
			<input type='hidden' name='actionSubmitted' value='connectionAttempt'>\r
...
// 			$SB as Submit Button
			...
			$CurrentSetObj->getDataSubEntry('block_HTML', 'post_hidden_arti_page')."
			<input type='hidden' name='formSubmitted'	value='1'>
			<input type='hidden' name='origin'			value='ModuleAuthentification'>
			<input type='hidden' name='actionSubmitted' value='disconnection'>\r

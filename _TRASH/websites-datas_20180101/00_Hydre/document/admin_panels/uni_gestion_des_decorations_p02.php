...
function ligne_formulaire_deco_graphique ( $div , $nom_div , $x , $y , $b ,$p, $j ) {
	...
	if ( $x == 1 ) {
		...
		onChange=\"
		Gebi('".$GD_module_['module_nom']."_".$div."').style.width = this.value+'px';\r
	...
	if ( $y == 1 ) {
		...
		onChange=\"
		Gebi('".$GD_module_['module_nom']."_".$div."').style.height = this.value+'px';\r
		CalculeDecoModule ( '".$j."' , '".$GD_module_['module_nom']."' , 'formulaire_gdd' );
		\">px\r
		");
	}
	...
	if ( $p == 1 ) {
		...
		onChange=\"Gebi('".$GD_module_['module_nom']."_".$div."').style.backgroundPosition = this.value;\r
		\">\r
...
$md_type['20']['t'] = $tl_[$l]['md_type2'];	$md_type['20']['s'] = "";	$md_type['20']['db'] = "caligraphe";
...
$md_type['50']['t'] = $tl_[$l]['md_type5'];	$md_type['50']['s'] = "";	$md_type['50']['db'] = "exquise";
...
for ( $pv['i'] = $tab_infos['premier'] ; $pv['i'] <= $tab_infos['nbr'] ; $pv['i']++ ) { 
	...
	$pv['TabNom']['caligraphe']	= 2	;		$pv['TabCon']['2']	=	"caligraphe";
	$pv['TabNom']['1_div']		= 3 ;		$pv['TabCon']['3']	=	"1_div";
	$pv['TabNom']['elegance']	= 4	;		$pv['TabCon']['4']	=	"elegance";
	$pv['TabNom']['exquise']	= 5	;		$pv['TabCon']['5']	=	"exquise";
...
//		$pv['div_compteur_2'] = 1;
	...
	case "1_div":
		...
		<tr>\r
		<td style='background-image: url(../graph/universel/noir_50prct.png);'>\r
			<table style='
			width:".$pv['60pc']."px; 
			...
			onChange=\"Gebi('".$GD_module_['module_nom']."').style.backgroundColor = '#'+this.value;\"
			>\r
			</td>\r
			</tr>\r

...
$mt_ = array (
	"theme_id" => "2309209084951177343",
	"theme_name" => "JnsEng_aqua_01",
	"theme_title" => "Aqua",
	"theme_desc" => "Aqualand",
	"theme_date" => "1780229816",
	"blockMCount" => "2",
	"blockTCount" => "2",
	"blockGCount" => "3",
	"B01G" => array (
	...
	"B01T" => array (
		...
		"txt_font_name_normal" => "Arial",
		"txt_font_name_bold" => "Arial",
		"txt_font_name_italic" => "Arial",
		...
		"td_a_active_fg_col" => "#FFFFFF",
		"td_a_visited_fg_col" => "#FFFFFF",
		"input_fg_col" => "#000000",
		"input_bg_col" => "#FFFFFF",
	...
	"B20T" => array (
		...
		"ft3_width" => "16",
		"ft_height" => "32",
		"icon_directory" => "aqua_Aqua_icon_directory.png",
		"icon_erase" => "aqua_Aqua_icon_erase.png",
		"icon_ok" => "aqua_Aqua_icon_ok.png",
		"icon_nok" => "aqua_Aqua_icon_ko.png",
		"icon_left" => "aqua_Aqua_icon_left.png",
		"icon_right" => "aqua_Aqua_icon_right.png",
		"icon_top" => "aqua_Aqua_icon_up.png",
		"icon_bottom" => "aqua_Aqua_icon_down.png",
		"icon_question" => "aqua_Aqua_icon_question.png",
		"icon_notification" => "aqua_Aqua_icon_notification.png",
		"icon_width" => "32",
		"icon_height" => "32",
		"page_selector" => "display:inline-block; background-color:#80808030; border-radius:0.1cm; border:solid 1px #00000080; padding:0.2cm 0.35cm; margin:0.1cm;",
		"page_selector_highlight" => "display:inline-block; background-color:#80808080; border-radius:0.1cm; border:solid 1px #00000080; padding:0.2cm 0.35cm; margin:0.1cm;"
...
$ThemeDefinitionInstall = array (
	"admctrl_height" => array (
 		"def_id" => "8920519060982631797",
		"fk_theme_id" => "2309209084951177343",
		"def_type" => "0",
	...
	"bodyBg_color" => array (
 		"def_id" => "6487160541290590075",
		"fk_theme_id" => "2309209084951177343",
		"def_type" => "1",
		"def_name" => "bodyBg_color",
		"def_number" => "0",
		"def_string" => "000000"
	),
	"bodyBg_position" => array (
 		"def_id" => "6633134768183840089",
		"fk_theme_id" => "2309209084951177343",
		"def_type" => "1",
		"def_name" => "bodyBg_position",
		"def_number" => "0",
		"def_string" => "center top"
	),
	"bodyBg_repeat" => array (
 		"def_id" => "4128398533277869662",
		"fk_theme_id" => "2309209084951177343",
		"def_type" => "1",
		"def_name" => "bodyBg_repeat",
		"def_number" => "0",
		"def_string" => "repeat"
	),
	"bodyHeight" => array (
 		"def_id" => "2130907440849052716",
		"fk_theme_id" => "2309209084951177343",
		"def_type" => "1",
		"def_name" => "bodyHeight",
		"def_number" => "0",
	...
	"stylesheet_1" => array (
 		"def_id" => "7677839259373349457",
		"fk_theme_id" => "2309209084951177343",
		"def_type" => "1",
		"def_name" => "stylesheet_1",
		"def_number" => "0",
		"def_string" => "aqua_01.css"
	)
);
...
.mt_B01 h4, .mt_B02 h4, .mt_B03 h4, .mt_B04 h4, .mt_B05 h4, .mt_B06 h4, .mt_B07 h4, .mt_B08 h4, .mt_B09 h4, .mt_B10 h4, .mt_B11 h4, .mt_B12 h4, .mt_B13 h4, .mt_B14 h4, .mt_B15 h4, .mt_B16 h4, .mt_B17 h4, .mt_B18 h4, .mt_B19 h4, .mt_B21 h4, .mt_B22 h4, .mt_B23 h4, .mt_B24 h4, .mt_B25 h4, .mt_B26 h4, .mt_B27 h4, .mt_B28 h4, .mt_B29 h4, .mt_B30 h4 {font-family:Arial; font-size:20px; color:#000000; font-weight:bold;; }
.mt_B01 h5, .mt_B02 h5, .mt_B03 h5, .mt_B04 h5, .mt_B05 h5, .mt_B06 h5, .mt_B07 h5, .mt_B08 h5, .mt_B09 h5, .mt_B10 h5, .mt_B11 h5, .mt_B12 h5, .mt_B13 h5, .mt_B14 h5, .mt_B15 h5, .mt_B16 h5, .mt_B17 h5, .mt_B18 h5, .mt_B19 h5, .mt_B21 h5, .mt_B22 h5, .mt_B23 h5, .mt_B24 h5, .mt_B25 h5, .mt_B26 h5, .mt_B27 h5, .mt_B28 h5, .mt_B29 h5, .mt_B30 h5 {font-family:Arial; font-size:18px; color:#000000; font-weight:bold;; }
.mt_B01 h6, .mt_B02 h6, .mt_B03 h6, .mt_B04 h6, .mt_B05 h6, .mt_B06 h6, .mt_B07 h6, .mt_B08 h6, .mt_B09 h6, .mt_B10 h6, .mt_B11 h6, .mt_B12 h6, .mt_B13 h6, .mt_B14 h6, .mt_B15 h6, .mt_B16 h6, .mt_B17 h6, .mt_B18 h6, .mt_B19 h6, .mt_B21 h6, .mt_B22 h6, .mt_B23 h6, .mt_B24 h6, .mt_B25 h6, .mt_B26 h6, .mt_B27 h6, .mt_B28 h6, .mt_B29 h6, .mt_B30 h6 {font-family:Arial; font-size:16px; color:#000000; font-weight:bold;; }
.mt_B01 h7, .mt_B02 h7, .mt_B03 h7, .mt_B04 h7, .mt_B05 h7, .mt_B06 h7, .mt_B07 h7, .mt_B08 h7, .mt_B09 h7, .mt_B10 h7, .mt_B11 h7, .mt_B12 h7, .mt_B13 h7, .mt_B14 h7, .mt_B15 h7, .mt_B16 h7, .mt_B17 h7, .mt_B18 h7, .mt_B19 h7, .mt_B21 h7, .mt_B22 h7, .mt_B23 h7, .mt_B24 h7, .mt_B25 h7, .mt_B26 h7, .mt_B27 h7, .mt_B28 h7, .mt_B29 h7, .mt_B30 h7 {font-family:Arial; font-size:14px; color:#000000; font-weight:bold;; }
...
.mt_B01 input[type=text], .mt_B02 input[type=text], .mt_B03 input[type=text], .mt_B04 input[type=text], .mt_B05 input[type=text], .mt_B06 input[type=text], .mt_B07 input[type=text], .mt_B08 input[type=text], .mt_B09 input[type=text], .mt_B10 input[type=text], .mt_B11 input[type=text], .mt_B12 input[type=text], .mt_B13 input[type=text], .mt_B14 input[type=text], .mt_B15 input[type=text], .mt_B16 input[type=text], .mt_B17 input[type=text], .mt_B18 input[type=text], .mt_B19 input[type=text], .mt_B21 input[type=text], .mt_B22 input[type=text], .mt_B23 input[type=text], .mt_B24 input[type=text], .mt_B25 input[type=text], .mt_B26 input[type=text], .mt_B27 input[type=text], .mt_B28 input[type=text], .mt_B29 input[type=text], .mt_B30 input[type=text] {font-family:Arial; color:#000000; background-color:#FFFFFF; box-shadow: inset 5px 3px 3px #00000040; border-radius:10px; min-height: 24px; padding: 5px;; }
.mt_B01 input[type=password], .mt_B02 input[type=password], .mt_B03 input[type=password], .mt_B04 input[type=password], .mt_B05 input[type=password], .mt_B06 input[type=password], .mt_B07 input[type=password], .mt_B08 input[type=password], .mt_B09 input[type=password], .mt_B10 input[type=password], .mt_B11 input[type=password], .mt_B12 input[type=password], .mt_B13 input[type=password], .mt_B14 input[type=password], .mt_B15 input[type=password], .mt_B16 input[type=password], .mt_B17 input[type=password], .mt_B18 input[type=password], .mt_B19 input[type=password], .mt_B21 input[type=password], .mt_B22 input[type=password], .mt_B23 input[type=password], .mt_B24 input[type=password], .mt_B25 input[type=password], .mt_B26 input[type=password], .mt_B27 input[type=password], .mt_B28 input[type=password], .mt_B29 input[type=password], .mt_B30 input[type=password] {font-family:Arial; color:#000000; background-color:#FFFFFF; box-shadow: inset 5px 3px 3px #00000040; border-radius:10px; min-height: 24px; padding: 5px;; }
.mt_B01_CheckboxLabel, .mt_B02_CheckboxLabel, .mt_B03_CheckboxLabel, .mt_B04_CheckboxLabel, .mt_B05_CheckboxLabel, .mt_B06_CheckboxLabel, .mt_B07_CheckboxLabel, .mt_B08_CheckboxLabel, .mt_B09_CheckboxLabel, .mt_B10_CheckboxLabel, .mt_B11_CheckboxLabel, .mt_B12_CheckboxLabel, .mt_B13_CheckboxLabel, .mt_B14_CheckboxLabel, .mt_B15_CheckboxLabel, .mt_B16_CheckboxLabel, .mt_B17_CheckboxLabel, .mt_B18_CheckboxLabel, .mt_B19_CheckboxLabel, .mt_B21_CheckboxLabel, .mt_B22_CheckboxLabel, .mt_B23_CheckboxLabel, .mt_B24_CheckboxLabel, .mt_B25_CheckboxLabel, .mt_B26_CheckboxLabel, .mt_B27_CheckboxLabel, .mt_B28_CheckboxLabel, .mt_B29_CheckboxLabel, .mt_B30_CheckboxLabel {height:2em; display: grid; grid-template-columns: 1cm auto; gap 0.25cm;}
.mt_B01 input[type=checkbox], .mt_B02 input[type=checkbox], .mt_B03 input[type=checkbox], .mt_B04 input[type=checkbox], .mt_B05 input[type=checkbox], .mt_B06 input[type=checkbox], .mt_B07 input[type=checkbox], .mt_B08 input[type=checkbox], .mt_B09 input[type=checkbox], .mt_B10 input[type=checkbox], .mt_B11 input[type=checkbox], .mt_B12 input[type=checkbox], .mt_B13 input[type=checkbox], .mt_B14 input[type=checkbox], .mt_B15 input[type=checkbox], .mt_B16 input[type=checkbox], .mt_B17 input[type=checkbox], .mt_B18 input[type=checkbox], .mt_B19 input[type=checkbox], .mt_B21 input[type=checkbox], .mt_B22 input[type=checkbox], .mt_B23 input[type=checkbox], .mt_B24 input[type=checkbox], .mt_B25 input[type=checkbox], .mt_B26 input[type=checkbox], .mt_B27 input[type=checkbox], .mt_B28 input[type=checkbox], .mt_B29 input[type=checkbox], .mt_B30 input[type=checkbox] {transform: scale(1);}
.mt_B01 select, .mt_B02 select, .mt_B03 select, .mt_B04 select, .mt_B05 select, .mt_B06 select, .mt_B07 select, .mt_B08 select, .mt_B09 select, .mt_B10 select, .mt_B11 select, .mt_B12 select, .mt_B13 select, .mt_B14 select, .mt_B15 select, .mt_B16 select, .mt_B17 select, .mt_B18 select, .mt_B19 select, .mt_B21 select, .mt_B22 select, .mt_B23 select, .mt_B24 select, .mt_B25 select, .mt_B26 select, .mt_B27 select, .mt_B28 select, .mt_B29 select, .mt_B30 select {color:#000000; background-color:#FFFFFF; box-shadow: inset 5px 3px 3px #00000040; border-radius:10px; min-height: 24px; padding: 5px;; }
.mt_B01 textarea, .mt_B02 textarea, .mt_B03 textarea, .mt_B04 textarea, .mt_B05 textarea, .mt_B06 textarea, .mt_B07 textarea, .mt_B08 textarea, .mt_B09 textarea, .mt_B10 textarea, .mt_B11 textarea, .mt_B12 textarea, .mt_B13 textarea, .mt_B14 textarea, .mt_B15 textarea, .mt_B16 textarea, .mt_B17 textarea, .mt_B18 textarea, .mt_B19 textarea, .mt_B21 textarea, .mt_B22 textarea, .mt_B23 textarea, .mt_B24 textarea, .mt_B25 textarea, .mt_B26 textarea, .mt_B27 textarea, .mt_B28 textarea, .mt_B29 textarea, .mt_B30 textarea {color:#000000; background-color:#FFFFFF; box-shadow: inset 5px 3px 3px #00000040; border-radius:10px; min-height: 24px; padding: 5px;; }
...
.mt_B20 h4 {font-family:Arial; font-size:20px; color:#FFFFFF; font-weight:bold;; }
.mt_B20 h5 {font-family:Arial; font-size:18px; color:#FFFFFF; font-weight:bold;; }
.mt_B20 h6 {font-family:Arial; font-size:16px; color:#FFFFFF; font-weight:bold;; }
.mt_B20 h7 {font-family:Arial; font-size:14px; color:#FFFFFF; font-weight:bold;; }
...
.mt_B20_icon_directory  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_directory.png); }
.mt_B20_icon_erase  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_erase.png); }
.mt_B20_icon_ok  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_ok.png); }
.mt_B20_icon_nok  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_ko.png); }
.mt_B20_icon_left  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_left.png); }
.mt_B20_icon_right  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_right.png); }
.mt_B20_icon_top  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_up.png); }
.mt_B20_icon_bottom  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_down.png); }
.mt_B20_icon_question  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_question.png); }
.mt_B20_icon_notification  { background-size: contain; background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_Aqua_icon_notification.png); }
...
.mt_menu_lvl_0_link  { font-family:Arial; color:#000000; text-decoration:none; }
.mt_menu_lvl_0_link:hover  { color:#000000; font-weight:bold; }
.mt_menu_lvl_0_link:active  { color:#000000;  }
.mt_menu_lvl_0_link:visited  { color:#000000;  }
...
.mt_menu_lvl_1_link, .mt_menu_lvl_2_link, .mt_menu_lvl_3_link, .mt_menu_lvl_4_link, .mt_menu_lvl_5_link, .mt_menu_lvl_6_link, .mt_menu_lvl_7_link, .mt_menu_lvl_8_link, .mt_menu_lvl_9_link  { font-family:Arial; color:#000000; text-decoration:none; }
.mt_menu_lvl_1_link:hover, .mt_menu_lvl_2_link:hover, .mt_menu_lvl_3_link:hover, .mt_menu_lvl_4_link:hover, .mt_menu_lvl_5_link:hover, .mt_menu_lvl_6_link:hover, .mt_menu_lvl_7_link:hover, .mt_menu_lvl_8_link:hover, .mt_menu_lvl_9_link:hover  { color:#000000; font-weight:bold; }
.mt_menu_lvl_1_link:active, .mt_menu_lvl_2_link:active, .mt_menu_lvl_3_link:active, .mt_menu_lvl_4_link:active, .mt_menu_lvl_5_link:active, .mt_menu_lvl_6_link:active, .mt_menu_lvl_7_link:active, .mt_menu_lvl_8_link:active, .mt_menu_lvl_9_link:active  { color:#000000;  }
.mt_menu_lvl_1_link:visited, .mt_menu_lvl_2_link:visited, .mt_menu_lvl_3_link:visited, .mt_menu_lvl_4_link:visited, .mt_menu_lvl_5_link:visited, .mt_menu_lvl_6_link:visited, .mt_menu_lvl_7_link:visited, .mt_menu_lvl_8_link:visited, .mt_menu_lvl_9_link:visited  { color:#000000;  }
...
.mt_bareTable   {background-color:transparent !important; border-spacing:0px; border-collapse:collapse; border-width:0px; border-style:none; margin:0px; padding:0px;}
...
.mt_bareTable:hover {background-color:transparent !important;}
.mt_bareTable tr:hover {background-color:transparent !important;}
.mt_bareTable td:hover {background-color:transparent !important;}
...
.mt_div_AdminControlSwitch { 
 ...
 .mt_div_AdminControlPanel {
  ...
  margin : auto;
  padding : 0px;
  background-image: url(http://www.local-janus-engine.com/media/theme/Aqua/aqua_bg.png);
  visibility: hidden; 
 }
 ...
 .mt_FileSelector {
  ...
  border-color: #FF8000; 
  margin : 0mm;
  padding : 0.5mm;font-family:Arial;font-size:14px;color:#000000;background-color: #55749280;
  visibility: hidden; display : none; 
  cursor: pointer;
 }

...
class ModuleGlobalReport
{
	...
	private function reportTab02(&$infos)
	{
		...
		foreach ($log as $l) {
			...
			$curMemory = round(($l['memory'] / 1024 / 1024), 6);
			...
			if ($stepOne === true) {
				...
				$mainTimeSpent = ($mainTimeEnd - $l['time']);
			} else {
				$dataObjectChart2['data']['datasets'][0]['data'][] = round(($l['time'] - $timeStart), 4);
			}
			$dataObjectChart2['data']['labels'][] = $l['context'];
			$dataObjectChart3['data']['datasets'][0]['data'][] = ($curMemory / $highestMemory) * 100;
			$dataObjectChart3['data']['datasets'][1]['data'][] = round((($l['time'] - $timeStart) / $mainTimeSpent) * 100, 4);
	...
	private function reportTab03(&$infos)
	{
		...
		$Content['1']['1']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t2l11');
		$Content['1']['1']['class'] = $Block . "_tb3";
		$Content['1']['1']['1']['style'] = "text-align: center;";
		$Content['1']['2']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t2l12');
		$Content['1']['2']['class'] = $Block . "_tb3";
		$Content['1']['3']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t2l13');
		$Content['1']['3']['class'] = $Block . "_tb3";
		$Content['1']['1']['3']['style'] = "text-align: center;";
		$Content['1']['4']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t2l14');
		$Content['1']['4']['class'] = $Block . "_tb3";
		$Content['1']['1']['4']['style'] = "text-align: center;";
		$Content['1']['5']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t2l15');
		$Content['1']['5']['class'] = $Block . "_tb3";
		$Content['1']['1']['5']['style'] = "text-align: center;";
		$Content['1']['6']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t2l16');
		$Content['1']['6']['class'] = $Block . "_tb3";
	...
	private function reportTab04(&$infos)
	{
		...
		$Content['1']['1']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l11');
		$Content['1']['1']['class'] = $Block . "_tb3";
		$Content['1']['1']['style'] = "text-align: center;";
		$Content['1']['2']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l12');
		$Content['1']['2']['class'] = $Block . "_tb3";
		$Content['1']['2']['style'] = "text-align: center;";
		$Content['1']['3']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l13');
		$Content['1']['3']['class'] = $Block . "_tb3";
		$Content['1']['4']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l14');
		$Content['1']['4']['class'] = $Block . "_tb3";
		$Content['1']['4']['style'] = "text-align: center;";
		$Content['1']['5']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l15');
		$Content['1']['5']['class'] = $Block . "_tb3";
		$Content['1']['5']['style'] = "text-align: center;";
		$Content['1']['6']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l16');
		$Content['1']['6']['class'] = $Block . "_tb3";
		$Content['1']['6']['style'] = "text-align: center;";
		$Content['1']['7']['cont'] = $bts->I18nTransObj->getI18nTransEntry('t3l17');
		$Content['1']['7']['class'] = $Block . "_tb3";
		...
		while ($dbp =  $bts->SDDMObj->fetch_array_sql($dbquery)) {
			...
			switch (TRUE) {
				...
				case ($pv['log_action_longeur'] > 128):
					$dbp['log_action'] = substr($dbp['log_action'], 0, 59) . " [...] " . substr($dbp['log_action'], ($pv['log_action_longeur'] - 64), $pv['log_action_longeur']);
					break;
			}
			$Content[$i]['1']['cont'] = $dbp['log_id'];
			$Content[$i]['1']['tc'] = 1;
			$Content[$i]['1']['style'] = "text-align: center;";
			$Content[$i]['2']['cont'] = date("Y m d H:i:s", $dbp['log_date']);
			$Content[$i]['2']['tc'] = 1;
			$Content[$i]['2']['style'] = "text-align: center;";
			$Content[$i]['3']['cont'] = $dbp['log_initiator'];
			$Content[$i]['3']['tc'] = 2;
			$Content[$i]['4']['cont'] = $dbp['log_action'];
			$Content[$i]['4']['tc'] = 1;
			$Content[$i]['4']['style'] = "text-align: center;";
			$Content[$i]['5']['cont'] = $tabSignal[$dbp['log_signal']];
			$Content[$i]['5']['style'] = "text-align: center;";
			$Content[$i]['6']['cont'] = $dbp['log_msgid'];
			$Content[$i]['6']['tc'] = 1;
			$Content[$i]['6']['style'] = "text-align: center;";
			$Content[$i]['7']['cont'] = $dbp['log_contenu'];
			$Content[$i]['7']['tc'] = 1;
			$i++;
		}
	 ...
	 */ private function internalLogReport(&$infos)
	{
		...
		foreach ($bts->LMObj->getMsgLog() as $A) {
			$Content[$i]['1']['cont'] = $A['nbr'];
			$Content[$i]['2']['cont'] = $A['origin'];
			$Content[$i]['2']['style'] = "font-size:60%;";
			$Content[$i]['3']['cont'] = $A['message'];
			$Content[$i]['3']['style'] = "font-size:60%;";
			$i++;
		}
	...
	private function variablesReport(&$infos)
	{
		...
		$config = $bts->RenderTablesObj->getDefaultTableConfig(($i - 1), 2, 1);

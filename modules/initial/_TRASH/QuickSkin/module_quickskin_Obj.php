...
// 		$SMObj = SessionManagement::getInstance(null);
		...
		$i18n = array();
		include ("../modules/initial/QuickSkin/i18n/".$l.".php");
		...
		if ( $grp == "1" ) {
			...
			if ( $SDDMObj->num_row_sql($dbquery) > 0 ) {
				...
				".$i18n['txt2']."
				<select name='user[pref_theme]' class='" . $ThemeDataObj->getThemeName().$infos['block']."_form_1 " . $ThemeDataObj->getThemeName().$infos['block']."_t3'>
				";
				...
				<input type='hidden' name='formOrigin'		value='ModuleQuickSkin'>
...
// 				<input type='hidden' name='M_UTILIS[login]'						value='".$SMObj->getSessionEntry('LoginDecoded')."'>\r

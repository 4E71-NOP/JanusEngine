...
class ModuleGlobalReport {
	...
	public function render (&$infos){
		...
		$T = array();
// 		$infos['block'] = $ThemeDataObj->dsqqdfs();
		
		$i18n = array();
		include ("../modules/initial/GlobalReport/i18n/".$l.".php");
		$infos['i18n'] = $i18n;
		
		$Content = "";
		
		$CurrentTab = 1;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 1 )	{ $tmp = $this->reportTab01($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 2;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 2 )	{ $tmp = $this->reportTab02($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 3;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 3 )	{ $tmp = $this->reportTab03($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 4;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 4 )	{ $tmp = $this->reportTab04($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 5;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 7 )	{ $tmp = $this->reportTab07($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 6;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 8 )	{ $tmp = $this->reportTab08($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 7;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 9 )	{ $tmp = $this->reportTab09($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
		$CurrentTab = 8;	if ( $WebSiteObj->getWebSiteEntry('sw_info_debug') >= 10 )	{ $tmp = $this->reportTab10($infos);	$T['AD'][$CurrentTab] = $tmp['content']; $T['ADC']['onglet'][$CurrentTab] = $tmp['config']; }	else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['defaut']; }
// 			include ("../modules/initial/AdminInfoDebug/maid_aff_var.php");
// 			affiche_array_table ( $GLOBALS , $CurrentTab );
// 			$ADC['onglet'][$CurrentTab]['nbr_cellule'] = 2;	$ADC['onglet'][$CurrentTab]['legende'] = 1;
// 		}
// 		else { $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 1;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 1;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0; $T['AD'][$CurrentTab]['1']['1']['cont'] = $tl_[$l]['defaut']; }
		
// 		$LMObj->getSqlQueryLog();
		...
		$T['tab_infos']['GroupName']		= "aid";
		$T['tab_infos']['CellName']			= "tab";
		$T['tab_infos']['DocumentName']		= "doc";
		$T['tab_infos']['cell_1_txt']		= $i18n['tab1'];
		$T['tab_infos']['cell_2_txt']		= $i18n['tab2'];
		$T['tab_infos']['cell_3_txt']		= $i18n['tab3'];
		$T['tab_infos']['cell_4_txt']		= $i18n['tab4'];
		$T['tab_infos']['cell_5_txt']		= $i18n['tab5'];
		$T['tab_infos']['cell_6_txt']		= $i18n['tab6'];
		$T['tab_infos']['cell_7_txt']		= $i18n['tab7'];
		$T['tab_infos']['cell_8_txt']		= $i18n['tab8'];
		$T['tab_infos']['cell_9_txt']		= $i18n['tab9'];
		$T['tab_infos']['cell_10_txt']		= $i18n['tab10'];
	...
	private function reportTab01 (&$infos){
		...
		$Content['1']['1']['cont']		= $i18n['t1l11'];
		$Content['2']['1']['cont']		= $i18n['t1l21'];
		$Content['3']['1']['cont']		= $i18n['t1l31'];
		$Content['4']['1']['cont']		= $i18n['t1l41'];
		$Content['5']['1']['cont']		= $i18n['t1l51'];
		$Content['6']['1']['cont']		= $i18n['t1l61'];
		$Content['7']['1']['cont']		= $i18n['t1l71'];
		$Content['8']['1']['cont']		= $i18n['t1l81'];
		$Content['9']['1']['cont']		= $i18n['t1l91'];
		$Content['10']['1']['cont']		= $i18n['t1l101'];
		$Content['11']['1']['cont']		= $i18n['t1l111'];
		$Content['12']['1']['cont']		= $i18n['t1l121'];
		...
		$Content['2']['2']['cont']		= round(($memory_['peak']/1024), 2) . $i18n['Ko'];		$Content['2']['2']['class']		= $infos['block']."_tb4";
		$Content['3']['2']['cont']		= phpversion();											$Content['3']['2']['class']		= $infos['block']."_tb4";
		$Content['4']['2']['cont']		= round(($memory_['usage']/1024), 2) . $i18n['Ko'];		$Content['4']['2']['class']		= $infos['block']."_tb4";
	...
	private function reportTab03 (&$infos){
		...
		$Content['1']['1']['cont'] = $i18n['t2l11'];	$Content['1']['1']['class'] = $block."_tb3";	$Content['1']['1']['1']['style'] = "text-align: center;";
		$Content['1']['2']['cont'] = $i18n['t2l12'];	$Content['1']['2']['class'] = $block."_tb3";
		$Content['1']['3']['cont'] = $i18n['t2l13'];	$Content['1']['3']['class'] = $block."_tb3";	$Content['1']['1']['3']['style'] = "text-align: center;";
		$Content['1']['4']['cont'] = $i18n['t2l14'];	$Content['1']['4']['class'] = $block."_tb3";	$Content['1']['1']['4']['style'] = "text-align: center;";
		$Content['1']['5']['cont'] = $i18n['t2l15'];	$Content['1']['5']['class'] = $block."_tb3";	$Content['1']['1']['5']['style'] = "text-align: center;";
		$Content['1']['6']['cont'] = $i18n['t2l16'];	$Content['1']['6']['class'] = $block."_tb3";
...
// 			$A['tempsY'] = floor (($sg['y']-$sg['bordB']) - (($A['temps']-$sg['tempsAV'])/$sg['tempscoef']));
	...
	private function reportTab04 (&$infos){
		...
		$Content['1']['1']['cont'] = $i18n['t3l11'];	$Content['1']['1']['class'] = $block."_tb3";	$Content['1']['1']['style'] = "text-align: center;";
		$Content['1']['2']['cont'] = $i18n['t3l12'];	$Content['1']['2']['class'] = $block."_tb3";	$Content['1']['2']['style'] = "text-align: center;";
		$Content['1']['3']['cont'] = $i18n['t3l13'];	$Content['1']['3']['class'] = $block."_tb3";
		$Content['1']['4']['cont'] = $i18n['t3l14'];	$Content['1']['4']['class'] = $block."_tb3";	$Content['1']['4']['style'] = "text-align: center;";
		$Content['1']['5']['cont'] = $i18n['t3l15'];	$Content['1']['5']['class'] = $block."_tb3";	$Content['1']['5']['style'] = "text-align: center;";
		$Content['1']['6']['cont'] = $i18n['t3l16'];	$Content['1']['6']['class'] = $block."_tb3";	$Content['1']['6']['style'] = "text-align: center;";
		$Content['1']['7']['cont'] = $i18n['t3l17'];	$Content['1']['7']['class'] = $block."_tb3";
	...
	private function reportTab07 (&$infos){
		...
		$Content['1']['1']['cont']		= $i18n['t6l11'];	$Content['1']['1']['class'] = $block."_tb3";	$Content['1']['1']['style'] = "text-align: center;";  
		$Content['1']['2']['cont']		= $i18n['t6l12'];	$Content['1']['2']['class'] = $block."_tb3";
		$Content['1']['3']['cont']		= $i18n['t6l13'];	$Content['1']['3']['class'] = $block."_tb3";	$Content['1']['3']['style'] = "text-align: center;";  
		$Content['1']['4']['cont']		= $i18n['t6l14'];	$Content['1']['4']['class'] = $block."_tb3";
...
// 			$queryTimeTotal += $queryTime;
	 ...
	 */private function reportTab09 (&$infos){
		...
		$Content['1']['1']['cont']	= $i18n['t9l11'];	$Content['1']['1']['class'] = $block."_tb3";	$Content['1']['1']['style'] = "text-align: center;";
		$Content['1']['2']['cont']	= $i18n['t9l12'];	$Content['1']['2']['class'] = $block."_tb2";
		$Content['1']['3']['cont']	= $i18n['t9l13'];	$Content['1']['3']['class'] = $block."_tb2";	$Content['1']['3']['style'] = "text-align: center;";
	...
	private function reportTab10 (&$infos){
		...
		$Content['1']['1']['cont'] = $i18n['t10l11'];	$Content['1']['1']['class'] = $block."_tb3";
		$Content['1']['2']['cont'] = $i18n['t10l12'];	$Content['1']['2']['class'] = $block."_tb3";

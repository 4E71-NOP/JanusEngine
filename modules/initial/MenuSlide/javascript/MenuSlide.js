...
class MenuSlide {
	...
	makeMenu() {
		...
		if (this.level > 1) {
			str += "<li class='"
				+ this.themeName
				+ "menu_lvl_0_link common_content' style='padding:0.05cm; margin-left:-0.5cm; list-style-type:none;' onClick='ms.slideBack()'><div class='"
				+ this.themeName + this.block
				+ "_icon_left' style='width:16px;height:16px; display:inline-block;'></div>&nbsp;" + menuSlideI18n.back + "</li>";
		}
		let d = this.data;
		for (let n in d) {

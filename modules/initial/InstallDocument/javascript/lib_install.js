...
class LibInstall {
	...
	setFormPreconizedSettings() {
		...
		l.Log[this.dbgInstFonction]('addMemory=: ' + addMemory + ", addTime=" + addTime);
		...
		for (var ptr in enabledDirectoryList) {
			...
			addMemory += (document.forms['install_page_init'].elements[enabledDirectoryList[ptr]].checked == true) ? 10 : 0;
			addTime += (document.forms['install_page_init'].elements[enabledDirectoryList[ptr]].checked == true) ? 30 : 0;
		}

...
$i18n = array(
	...
	't4l2c2' => "",
	't4l2c4'	=> "Select the DAL you want to use. Warning PEAR DB is deprecated. AdoDB is experimental at the moment.",			
	...
	't4l5c2' => "",
	't4l5c3' => "",
	't4l5c4' => "This is the server where the database is. use 'localhost' or 'mysql' (Docker, etc) or the server IP address. Otherwise check with the webhosting provider.",
	't4l6c1'	=> "Prefix",
	't4l6c2'	=> "",
	't4l6c3'	=> "",
	't4l6c4'	=> "Sometimes a prefix is needed. Usually it's your account login provided by your webhosting provider. Ex : myaccount_ + DBuser. Enter the prefix in this filed only.",
	't4l7c1'	=> "Database name",
	't4l7c2'	=> "",
	't4l7c3'	=> "",
	't4l7c4'	=> "This is the database name on the server.",
	't4l8c1'	=> "Admin login",
	't4l8c2'	=> "",
	't4l8c3'	=> "",
	't4l8c4'	=> "Enter a login that has enough privileges to create databases, tables and users on the DB server. ",
	't4l9c1'	=> "Password",
	't4l9c2'	=> "",
	't4l9c3'	=> "",
	't4l9c4'	=> "",
	...
	't5l4c1'	=> "Password",
	't5l4c2'	=> "",
	't5l4c3'	=> "Click to unveil password",

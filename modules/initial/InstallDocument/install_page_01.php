...
class InstallPage01
{
	...
	private function installationMethod($infos, $t)
	{
		...
		$T[$t][$l]['1']['cont'] = "<input type='radio' name='form[operatingMode]' checked onClick='li.setFormPreconizedSettings()' value='directCnx'>" .	$bts->I18nTransObj->getI18nTransEntry('MTH_opt1') . $bubbleBegin . $bts->I18nTransObj->getI18nTransEntry('MTH_opt1Help') . $bubbleEnd;

...
function manipulation_decoration () {
	global $site_web, $SQL_tab, $SQL_requete, $SQL_tab_abrege, $db;
	$R = &$_REQUEST['M_DECORA'];
...
//		Creation de decoration
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				$R['deco_ref_id'] 	= manipulation_trouve_id_suivant ( $SQL_tab_abrege['decoration'] , "deco_ref_id" );
			...
			// isoler ce bloc pour ne l'avoir actif uniquement dans les deco 30 40 50 60
				$R['deco_id'] 		= manipulation_trouve_id_suivant ( $SQL_tab_abrege[$pv['SQL_table']] , "deco_id" );
				$R['deco_nligne'] 	= manipulation_trouve_id_suivant ( $SQL_tab_abrege[$pv['SQL_table']] , "deco_nligne" );
				...
				$requete1 = "INSERT INTO ".$SQL_tab_abrege[$pv['SQL_table']]." VALUES ".$requete_valeurs.";";
				manipulation_traitement_requete ( $requete1 );

				$requete2 = "
				INSERT INTO ".$SQL_tab_abrege['decoration']." VALUES (
				'".$R['deco_ref_id']."',
				'".$R['deco_nom']."',
				'1',
				'".$R['deco_type']."',
...
//		Modification de decoration depuis l'interface
		case 2:
			...
			if ( $R['ERR'] != 1 ) {
				...
				manipulation_traitement_requete ( $requete1 );
				$requete2 = "
				UPDATE ".$SQL_tab_abrege['decoration']." SET 

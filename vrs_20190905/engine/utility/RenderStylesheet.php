...
";
	...
	.".$tableName.CLASS_File_Selector." {
		...
		((strlen($themeArray['B01T']['tab_frame_bg_img'])>0) ? "background-image: url(".$baseUrl."media/theme/".$themeArray['theme_directory']."/".$themeArray['B01T']['tab_frame_bg_img'].");":"").
...
@media print { BODY { font-size: 10pt; } }\r\r-->\r</style>\r";
	...
	private function renderStylesheetDeco20 (&$infos) {
		...
		if ( strlen($p['ft1_bg'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft1",				" { padding: 0px;	border: 0px;	width: ".$p['ft1_width']."px;	height: ".$p['ft_height']."px;	".((strlen($p['ft1_bg'] )>0)? "background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['ft1_bg'].");" :"")."	".$p['ft1_special']. " } \r");																												}
		if ( strlen($p['ft2_bg'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft2",				" { padding: 0px;	border: 0px;									height: ".$p['ft_height']."px;	".((strlen($p['ft2_bg'] )>0)? "background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['ft2_bg'].");" :"")."	".$p['ft2_special']. " 	color: ".$p['ft2_fg_col']."; font-size:".$p['ft2_font_size'].$fontUnit."; } \r");									}
		if ( strlen($p['ft3_bg'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft3",				" { padding: 0px;	border: 0px;	width: ".$p['ft3_width']."px;	height: ".$p['ft_height']."px;	".((strlen($p['ft3_bg'] )>0)? "background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['ft3_bg'].");" :"")."	".$p['ft3_special']. " } \r");																												}
		if ( strlen($p['s1_n01'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n01",		" { width: ".$p['s1_01_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s1_n01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].";}\r");																						}
		if ( strlen($p['s1_n02'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n02",		" { 								height: ".$p['s1_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s1_n02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].	";		font-weight:".$p['s1_txt_weight'].";		".$p['s1_txt_special'].";	}\r");		}
		if ( strlen($p['s1_n03'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n03",		" { width: ".$p['s1_03_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s1_n03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].";}\r");																						}
		if ( strlen($p['s1_h01'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h01",		" { width: ".$p['s1_01_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s1_h01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";}\r");																				}
		if ( strlen($p['s1_h02'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h02",		" { 								height: ".$p['s1_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s1_h02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";	font-weight:".$p['s1_txt_hover_weight'].";	".$p['s1_txt_hover_special'].";	}\r");	}
		if ( strlen($p['s1_h03'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h03",		" { width: ".$p['s1_03_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s1_h03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";}\r");																				}
		if ( strlen($p['s2_n01'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n01",		" { width: ".$p['s2_01_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s2_n01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";}\r");																						}
		if ( strlen($p['s2_n02'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n02",		" { 								height: ".$p['s2_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s2_n02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";		font-weight:".$p['s2_txt_weight'].";		".$p['s2_txt_special'].";	}\r");		}
		if ( strlen($p['s2_n03'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n03",		" { width: ".$p['s2_03_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s2_n03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";}\r");																						}
		if ( strlen($p['s2_h01'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h01",		" { width: ".$p['s2_01_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s2_h01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";}\r");																				}
		if ( strlen($p['s2_h02'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h02",		" { 								height: ".$p['s2_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s2_h02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";	font-weight:".$p['s2_txt_hover_weight'].";	".$p['s2_txt_hover_special'].";	}\r");	}
		if ( strlen($p['s2_h03'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h03",		" { width: ".$p['s2_03_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s2_h03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";}\r");																				}
		if ( strlen($p['s3_n01'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n01",		" { width: ".$p['s3_01_width']."px;	height: ".$p['s3_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s3_n01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";}\r");																						}
		if ( strlen($p['s3_n02'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n02",		" { 								height: ".$p['s3_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s3_n02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";		font-weight:".$p['s3_txt_weight'].";		".$p['s3_txt_special'].";	}\r");		}
		if ( strlen($p['s3_n03'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n03",		" { width: ".$p['s3_03_width']."px;	height: ".$p['s3_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s3_n03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";}\r");																						}
		if ( strlen($p['s3_h01'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_h01",		" { width: ".$p['s3_01_width']."px;	height: ".$p['s3_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s3_h01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_hover_col'].";}\r");																				}
		if ( strlen($p['s3_h02'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_h02",		" { 								height: ".$p['s3_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s3_h02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_hover_col'].";	font-weight:".$p['s3_txt_hover_weight'].";	".$p['s3_txt_hover_special'].";	}\r");	}
		if ( strlen($p['s3_h03'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_h03",		" { width: ".$p['s3_03_width']."px;	height: ".$p['s3_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['s3_h03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_hover_col'].";}\r\r");																				}
		if ( strlen($p['tab_down_a'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_a",			" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_down_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	:""		)."; }\r");										}
		if ( strlen($p['tab_down_b'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_b",			" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_down_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";	".((strlen($p['tab_down_txt_weight'])>0) ? "font-weight:".$p['tab_down_txt_weight'].";":"")."	".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	:""		).";	".$p['tab_down_txt_special']."	}\r");	}
		if ( strlen($p['tab_down_c'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_c",			" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_down_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	: ""	)."; }\r");										}
		if ( strlen($p['tab_up_a'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_a",			" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_up_a'].");		padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	)."; }\r");										}
		if ( strlen($p['tab_up_b'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_b",			" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_up_b'].");		padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";	".((strlen($p['tab_up_txt_weight'])>0) ? "font-weight:".$p['tab_up_txt_weight'].";":"")."		".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	).";	".$p['tab_up_txt_special']."	}\r" );	}
		if ( strlen($p['tab_up_c'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_c",			" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_up_c'].");		padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	)."; }\r" );									}
		if ( strlen($p['tab_hover_a'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_a",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_hover_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	)."; }\r");										}
		if ( strlen($p['tab_hover_b'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_b",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_hover_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";	".((strlen($p['tab_hover_txt_weight'])>0) ? "font-weight:".$p['tab_hover_txt_weight'].";":"")."	".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	).";	".$p['tab_hover_txt_special']."	}\r");	}
		if ( strlen($p['tab_hover_c'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_c",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_hover_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	)."; }\r");										}
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tabFrame",			" { padding: 5px ; vertical-align: top; ".((strlen($p['tab_frame_bg_img'])>0) ? "background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_frame_bg_img'].");" : "")."  ".((strlen($p['tab_frame_bg_col'])>0) ? "background-color: ".$p['tab_frame_bg_col'].";":"")." }\r\r");

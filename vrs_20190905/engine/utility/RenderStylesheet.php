...
";
	...
	.".$tableName."div_SelecteurDeFichier {
		...
		margin : 0px;
		padding : 4px;
		background-image: url(../gfx/".$themeArray['theme_directory']."/".$themeArray['B01T']['bgco'].");
		visibility: hidden; display : none; 
		cursor: pointer;
	}
...
@media print { BODY { font-size: ".$themeArray['B01T']['txt_fonte_size_min']."pt; } }\r\r-->\r</style>\r";
	...
	private function renderStylesheetDeco20 (&$infos) {
		...
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft1",				" { padding: 0px;	border: 0px;	width: ".$p['ft1_x']."px;	height: ".$p['ft_y']."px;	background-image: url(../gfx/".$infos['theme_directory']."/".$p['ft1']."); } \r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft2",				" { padding: 0px;	border: 0px;								height: ".$p['ft_y']."px;	background-image: url(../gfx/".$infos['theme_directory']."/".$p['ft2'].");	color: ".$p['txt_titre_col']."; } \r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft3",				" { padding: 0px;	border: 0px;	width: ".$p['ft3_x']."px;	height: ".$p['ft_y']."px;	background-image: url(../gfx/".$infos['theme_directory']."/".$p['ft3']."); } \r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fca",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgca'].");  color: ".$p['ca_txt_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fcb",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgcb'].");  color: ".$p['cb_txt_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fcc",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgcc'].");  color: ".$p['cc_txt_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fcd",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgcd'].");  color: ".$p['cd_txt_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fcta",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgcta']."); color: ".$p['cta_txt_col']."; }\r"); 
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fctb",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgctb']."); color: ".$p['ctb_txt_col']."; }\r"); 
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fcsa",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgcsa']."); color: ".$p['csa_txt_col']."; }\r"); 
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fcsb",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgcsb']."); color: ".$p['csb_txt_col']."; }\r"); 
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_fco",				" { padding: 5px ; vertical-align: top; background-image: url(../gfx/".$infos['theme_directory']."/".$p['bgco'].");  color: ".$p['co_txt_col']."; }\r\r");
		...
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n01",		" { width: ".$p['s1_01_x']."px;	height: ".$p['s1_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s1_n01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n02",		" { 							height: ".$p['s1_01_y']."px; background: transparent;			background-image: url(../gfx/".$infos['theme_directory']."/".$p['s1_n02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].	";		font-weight:".$p['s1_txt_weight'].";		text-shadow: ".$p['s1_txt_shadow'].";	}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n03",		" { width: ".$p['s1_03_x']."px;	height: ".$p['s1_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s1_n03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h01",		" { width: ".$p['s1_01_x']."px;	height: ".$p['s1_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s1_h01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h02",		" { 							height: ".$p['s1_01_y']."px; background: transparent;			background-image: url(../gfx/".$infos['theme_directory']."/".$p['s1_h02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";	font-weight:".$p['s1_txt_hover_weight'].";	text-shadow: ".$p['s1_txt_hover_shadow'].";	}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h03",		" { width: ".$p['s1_03_x']."px;	height: ".$p['s1_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s1_h03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n01",		" { width: ".$p['s2_01_x']."px;	height: ".$p['s2_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s2_n01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n02",		" { 							height: ".$p['s2_01_y']."px; background: transparent;			background-image: url(../gfx/".$infos['theme_directory']."/".$p['s2_n02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";		font-weight:".$p['s2_txt_weight'].";		text-shadow: ".$p['s2_txt_shadow'].";	}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n03",		" { width: ".$p['s2_03_x']."px;	height: ".$p['s2_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s2_n03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h01",		" { width: ".$p['s2_01_x']."px;	height: ".$p['s2_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s2_h01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h02",		" { 							height: ".$p['s2_01_y']."px; background: transparent;			background-image: url(../gfx/".$infos['theme_directory']."/".$p['s2_h02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";	font-weight:".$p['s2_txt_hover_weight'].";	text-shadow: ".$p['s2_txt_hover_shadow'].";	}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h03",		" { width: ".$p['s2_03_x']."px;	height: ".$p['s2_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s2_h03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n01",		" { width: ".$p['s3_01_x']."px;	height: ".$p['s3_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s3_n01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n02",		" { 							height: ".$p['s3_01_y']."px; background: transparent;			background-image: url(../gfx/".$infos['theme_directory']."/".$p['s3_n02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";		font-weight:".$p['s3_txt_weight'].";		text-shadow: ".$p['s3_txt_shadow'].";	}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n03",		" { width: ".$p['s3_03_x']."px;	height: ".$p['s3_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s3_n03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_h01",		" { width: ".$p['s3_01_x']."px;	height: ".$p['s3_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s3_h01'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_hover_col'].";}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_h02",		" { 									height: ".$p['s3_01_y']."px; background: transparent;	background-image: url(../gfx/".$infos['theme_directory']."/".$p['s3_h02'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_hover_col'].";	font-weight:".$p['s3_txt_hover_weight'].";	text-shadow: ".$p['s3_txt_hover_shadow'].";	}\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_h03",		" { width: ".$p['s3_03_x']."px;	height: ".$p['s3_01_y']."px; 									background-image: url(../gfx/".$infos['theme_directory']."/".$p['s3_h03'].");	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_hover_col'].";}\r\r");
		...
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_a",			" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_down_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_x']."px;	height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									background-color: ".$p['tab_down_txt_bg_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_b",			" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_down_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;								height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";	font-weight: ".$p['tab_down_txt_weight'].";		text-shadow : ".$p['tab_down_txt_shadow'].";	background-color: ".$p['tab_down_txt_bg_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_c",			" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_down_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_x']."px;	height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									background-color: ".$p['tab_down_txt_bg_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_a",			" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_up_a'].");		padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_x']."px;	height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									background-color: ".$p['tab_up_txt_bg_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_b",			" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_up_b'].");		padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;								height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";	font-weight: ".$p['tab_up_txt_weight'].";		text-shadow : ".$p['tab_up_txt_shadow'].";		background-color: ".$p['tab_up_txt_bg_col']."; }\r" );
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_c",			" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_up_c'].");		padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_x']."px;	height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									background-color: ".$p['tab_up_txt_bg_col']."; }\r" );
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_a",		" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_hover_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_x']."px;	height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									background-color: ".$p['tab_hover_txt_bg_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_b",		" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_hover_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;								height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";	font-weight: ".$p['tab_hover_txt_weight'].";	text-shadow : ".$p['tab_hover_txt_shadow'].";	background-color: ".$p['tab_hover_txt_bg_col']."; }\r");
		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_c",		" { background-image: url(../gfx/".$infos['theme_directory']."/".$p['tab_hover_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_x']."px;	height: ".$p['tab_y']."px;	background-position: top left;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									background-color: ".$p['tab_hover_txt_bg_col']."; }\r\r");

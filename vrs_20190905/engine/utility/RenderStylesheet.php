...
";
	...
	private function renderStylesheetDeco20 (&$infos) {
		...
		if ( strlen($p['ft1_bg'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft1",				" { padding: 0px;	border: 0px;	width: ".$p['ft1_width']."px;	height: ".$p['ft_height']."px;	".((strlen($p['ft1_bg'] )>0)? "background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['ft1_bg'].");" :"")."	".$p['ft1_special']. " } \r");																												}
		if ( strlen($p['ft2_bg'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft2",				" { padding: 0px;	border: 0px;									height: ".$p['ft_height']."px;	".((strlen($p['ft2_bg'] )>0)? "background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['ft2_bg'].");" :"")."	".$p['ft2_special']. " 	color: ".$p['ft2_fg_col']."; font-size:".$p['ft2_font_size'].$fontUnit."; } \r");									}
		if ( strlen($p['ft3_bg'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_ft3",				" { padding: 0px;	border: 0px;	width: ".$p['ft3_width']."px;	height: ".$p['ft_height']."px;	".((strlen($p['ft3_bg'] )>0)? "background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['ft3_bg'].");" :"")."	".$p['ft3_special']. " } \r");																												}

		if ( strlen($p['s1_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n01",		" { width: ".$p['s1_01_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s1_a'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].";}\r");																																		}
		if ( strlen($p['s1_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n02",		" { 								height: ".$p['s1_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s1_b'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].	";		font-weight:".$p['s1_txt_weight'].";		".$p['s1_txt_special'].";		font-size:".$p['txt_font_size']."px;	font-family: '".$p['txt_font_family']."';}\r");	}
		if ( strlen($p['s1_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_n03",		" { width: ".$p['s1_03_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s1_c'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_col'].";}\r");																																		}
		...
		if ( strlen($p['s1_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h02",		" { 								height: ".$p['s1_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s1_b'].");	background-position: ".$p['s1_offset_x']."px -".$p['s1_offset_y']."px;	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";	font-weight:".$p['s1_txt_hover_weight'].";	".$p['s1_txt_hover_special'].";	font-size:".$p['txt_font_size']."px;	font-family: '".$p['txt_font_family']."';}\r");	}
		if ( strlen($p['s1_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s1_h03",		" { width: ".$p['s1_03_width']."px;	height: ".$p['s1_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s1_c'].");	background-position: ".$p['s1_offset_x']."px -".$p['s1_offset_y']."px;	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s1_txt_hover_col'].";}\r");																																}

		if ( strlen($p['s2_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n01",		" { width: ".$p['s2_01_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s2_a'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";}\r");																																		}
		if ( strlen($p['s2_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n02",		" { 								height: ".$p['s2_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s2_b'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";		font-weight:".$p['s2_txt_weight'].";		".$p['s2_txt_special'].";		font-size:".$p['txt_font_size']."px;	font-family: '".$p['txt_font_family']."';}\r");	}
		if ( strlen($p['s2_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_n03",		" { width: ".$p['s2_03_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s2_c'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_col'].";}\r");																																		}
		...
		if ( strlen($p['s2_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h02",		" { 								height: ".$p['s2_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s2_b'].");	background-position: ".$p['s2_offset_x']."px -".$p['s2_offset_y']."px;	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";	font-weight:".$p['s2_txt_hover_weight'].";	".$p['s2_txt_hover_special'].";	font-size:".$p['txt_font_size']."px;	font-family: '".$p['txt_font_family']."';}\r");	}
		if ( strlen($p['s2_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s2_h03",		" { width: ".$p['s2_03_width']."px;	height: ".$p['s2_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s2_c'].");	background-position: ".$p['s2_offset_x']."px -".$p['s2_offset_y']."px;	border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s2_txt_hover_col'].";}\r");																																}

		if ( strlen($p['s3_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n01",		" { width: ".$p['s3_01_width']."px;	height: ".$p['s3_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s3_a'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";}\r");																																		}
		if ( strlen($p['s3_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n02",		" { 								height: ".$p['s3_01_height']."px; background: transparent;		background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s3_b'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";		font-weight:".$p['s3_txt_weight'].";		".$p['s3_txt_special'].";		font-size:".$p['txt_font_size']."px;	font-family: '".$p['txt_font_family']."';}\r");	 }
		if ( strlen($p['s3_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_submit_s3_n03",		" { width: ".$p['s3_03_width']."px;	height: ".$p['s3_01_height']."px; 								background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['s3_c'].");	background-position: 0px 0px;											border-width : 0px; 	padding: 0px;	border-style: none;	color: ".$p['s3_txt_col'].";}\r");																																		}
		...
		if ( strlen($p['tab_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_a",		" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*0)."px -".($p['tab_offset_y']*0)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	:""		)."; }\r");										}
		if ( strlen($p['tab_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_b",		" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*0)."px -".($p['tab_offset_y']*0)."px;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";	".((strlen($p['tab_down_txt_weight'])>0) ? "font-weight:".$p['tab_down_txt_weight'].";":"")."	".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	:""		).";	".$p['tab_down_txt_special']."	}\r");	}
		if ( strlen($p['tab_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_c",		" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*0)."px -".($p['tab_offset_y']*0)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	: ""	)."; }\r");										}
		if ( strlen($p['tab_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_a",		" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*1)."px -".($p['tab_offset_y']*1)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	)."; }\r");										}
		if ( strlen($p['tab_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_b",		" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*1)."px -".($p['tab_offset_y']*1)."px;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";	".((strlen($p['tab_up_txt_weight'])>0) ? "font-weight:".$p['tab_up_txt_weight'].";":"")."		".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	).";	".$p['tab_up_txt_special']."	}\r" );	}
		if ( strlen($p['tab_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_c",		" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*1)."px -".($p['tab_offset_y']*1)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	)."; }\r" );									}
		if ( strlen($p['tab_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_a",	" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*2)."px -".($p['tab_offset_y']*2)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	)."; }\r");										}
		if ( strlen($p['tab_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_b",	" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*2)."px -".($p['tab_offset_y']*2)."px;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";	".((strlen($p['tab_hover_txt_weight'])>0) ? "font-weight:".$p['tab_hover_txt_weight'].";":"")."	".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	).";	".$p['tab_hover_txt_special']."	}\r");	}
		if ( strlen($p['tab_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_c",	" { background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*2)."px -".($p['tab_offset_y']*2)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	)."; }\r");										}

		$Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tabFrame",			" { padding: 5px ; vertical-align: top; ".((strlen($p['tab_frame_bg_img'])>0) ? "background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['tab_frame_bg_img'].");" : "")."  ".((strlen($p['tab_frame_bg_col'])>0) ? "background-color: ".$p['tab_frame_bg_col'].";":"")." }\r\r");

		$protocol = ( $ServerInfosObj->getServerInfosEntry('sslState') == 1) ? "https://" : "http://" ;
		// New stylsheet
		// if (isset($p['txt_font_name_normal']) ) {
		// 	$Content .= "@font-face {	font-family: '".$p['txt_font_dl_name']."';							".((strlen($p['txt_font_name_normal'])>0) ? "src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['txt_font_dl_url']."'":"").");}\r";
		// }
			
		$rootPath = $CurrentSetObj->getInstanceOfServerInfosObj()->getServerInfosEntry('DOCUMENT_ROOT')."/media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/";
		...
		if ( 
			...
			// && file_exists($rootPath.$p['txt_font_filename_normal'])
				...
				$Content .= "@font-face {	font-family: '".$p['txt_font_name_normal']."'; src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['txt_font_filename_normal']."');}\r";
		}
		...
		if ( 
			...
			// && file_exists($rootPath.$p['txt_font_filename_bold'])
				...
				$Content .= "@font-face {	font-family: '".$p['txt_font_name_bold']."'; font-weight:bold; src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['txt_font_filename_bold']."');}\r";
		}
		...
		if ( 
			...
			// && file_exists($rootPath.$p['txt_font_filename_bold'])
				...
				$Content .= "@font-face {	font-family: '".$p['txt_font_name_italic']."'; font-style:italic; src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['txt_font_filename_italic']."');}\r";
		}
		...
		// Icons
		if ( strlen($p['icon_directory'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_directory",		" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_directory']."); }\r");		}
		if ( strlen($p['icon_erase'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_erase",			" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_erase']."); }\r");			}
		if ( strlen($p['icon_ok'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_ok",			" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_ok']."); }\r");				}
		if ( strlen($p['icon_nok'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_nok",			" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_nok']."); }\r");				}
		if ( strlen($p['icon_left'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_left",			" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_left']."); }\r");			}
		if ( strlen($p['icon_right'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_right",			" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_right']."); }\r");			}
		if ( strlen($p['icon_top'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_top",			" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_top']."); }\r");				}
		if ( strlen($p['icon_bottom'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_bottom",		" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_bottom']."); }\r");			}
		if ( strlen($p['icon_question'])>0)		{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_question",		" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_question']."); }\r");		}
		if ( strlen($p['icon_notification'])>0)	{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_icon_notification",	" { background-size: contain;	background-image: url(".$baseUrl."media/theme/".$this->ThemeDataObj->getDefinitionValue("directory")."/".$p['icon_notification']."); }\r");	}

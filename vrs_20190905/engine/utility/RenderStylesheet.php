...
";
	...
	private function renderStylesheetDeco20 (&$infos) {
		...
		if ( strlen($p['tab_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_a",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*0)."px -".($p['tab_offset_y']*0)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	:""		)."; }\r");										}
		if ( strlen($p['tab_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_b",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*0)."px -".($p['tab_offset_y']*0)."px;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";	".((strlen($p['tab_down_txt_weight'])>0) ? "font-weight:".$p['tab_down_txt_weight'].";":"")."	".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	:""		).";	".$p['tab_down_txt_special']."	}\r");	}
		if ( strlen($p['tab_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_down_c",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*0)."px -".($p['tab_offset_y']*0)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_down_txt_col'].";																									".((strlen($p['tab_down_txt_bg_col']	)>0) ? "background-color:".$p['tab_down_txt_bg_col']	: ""	)."; }\r");										}
		if ( strlen($p['tab_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_a",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*1)."px -".($p['tab_offset_y']*1)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	)."; }\r");										}
		if ( strlen($p['tab_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_b",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*1)."px -".($p['tab_offset_y']*1)."px;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";	".((strlen($p['tab_up_txt_weight'])>0) ? "font-weight:".$p['tab_up_txt_weight'].";":"")."		".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	).";	".$p['tab_up_txt_special']."	}\r" );	}
		if ( strlen($p['tab_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_up_c",		" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*1)."px -".($p['tab_offset_y']*1)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_up_txt_col'].";																									".((strlen($p['tab_up_txt_bg_col']		)>0) ? "background-color:".$p['tab_up_txt_bg_col']		: ""	)."; }\r" );									}
		if ( strlen($p['tab_a'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_a",	" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_a'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_a_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*2)."px -".($p['tab_offset_y']*2)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	)."; }\r");										}
		if ( strlen($p['tab_b'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_b",	" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_b'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;									height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*2)."px -".($p['tab_offset_y']*2)."px;	background-repeat : repeat-x;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";	".((strlen($p['tab_hover_txt_weight'])>0) ? "font-weight:".$p['tab_hover_txt_weight'].";":"")."	".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	).";	".$p['tab_hover_txt_special']."	}\r");	}
		if ( strlen($p['tab_c'])>0)			{ $Content .= $this->makeCssIdString ($infos, ".",		$infos['currentBlock'], "T", "_tab_hover_c",	" { background-image: url(".$baseUrl."media/theme/".$infos['theme_directory']."/".$p['tab_c'].");	padding-top: 0px;	padding-left: 0px;	vertical-align: bottom;	width: ".$p['tab_c_width']."px;	height: ".$p['tab_height']."px;	background-position: ".($p['tab_offset_x']*2)."px -".($p['tab_offset_y']*2)."px;	background-repeat : no-repeat;	overflow:hidden;	text-align: center;	color: ".$p['tab_hover_txt_col'].";																									".((strlen($p['tab_hover_txt_bg_col']	)>0) ? "background-color:".$p['tab_hover_txt_bg_col']	: ""	)."; }\r");										}
		...
		// 	$Content .= "@font-face {	font-family: '".$p['txt_font_dl_name']."';							".((strlen($p['txt_font_name_normal'])>0) ? "src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$infos['theme_directory']."/".$p['txt_font_dl_url']."'":"").");}\r";
		// }
			
		$rootPath = $CurrentSetObj->getInstanceOfServerInfosObj()->getServerInfosEntry('DOCUMENT_ROOT')."/media/theme/".$infos['theme_directory']."/";
		...
		if ( 
			...
			// && file_exists($rootPath.$p['txt_font_filename_normal'])
				...
				$Content .= "@font-face {	font-family: '".$p['txt_font_name_normal']."'; src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$infos['theme_directory']."/".$p['txt_font_filename_normal']."');}\r";
		}
		...
		if ( 
			...
			// && file_exists($rootPath.$p['txt_font_filename_bold'])
				...
				$Content .= "@font-face {	font-family: '".$p['txt_font_name_bold']."'; font-weight:bold; src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$infos['theme_directory']."/".$p['txt_font_filename_bold']."');}\r";
		}
		...
		if ( 
			...
			// && file_exists($rootPath.$p['txt_font_filename_bold'])
				...
				$Content .= "@font-face {	font-family: '".$p['txt_font_name_italic']."'; font-style:italic; src: url('".$protocol.$ServerInfosObj->getServerInfosEntry('srv_host')."/media/theme/".$infos['theme_directory']."/".$p['txt_font_filename_italic']."');}\r";
		}

...
class ClassLoader
{
	...
	private $classTab = array(
		...
		"CommonWebsiteTools"		=> _UTILITY_DIRECTORY_ . "CommonWebsiteTools.php",
		...
		"FormManagement"			=> _UTILITY_DIRECTORY_ . "FormManagement.php",
		...
		"SecurityToken"				=> _ENTITY_DIRECTORY_ . "dao/SecurityToken.php",

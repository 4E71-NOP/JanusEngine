...
class ClassLoader {
	...
	private $classTab = array(
		...
		"I18nTrans"					=> UtilityDirectory."I18nTrans.php",
		...
		"LanguageWebsite"			=> EntityDirectory."dao/LanguageWebsite.php",
		...
		"ModuleWebsite"				=> EntityDirectory."dao/ModuleWebsite.php",
		...
		"ThemeWebsite"				=> EntityDirectory."dao/ThemeWebsite.php",

...
background-image: url(../gfx/_staticPages/bg.jpg); 
...
'>
<tr>
<td style='text-align:center;'>	".$lc." <img src='../gfx/_staticPages/LogoGoogleChrome.png' border='0'>		".$lz."	</td>
<td style='text-align:center;'>	".$lf." <img src='../gfx/_staticPages/LogoMozillaFirefox.png' border='0'>	".$lz."	</td>
<td style='text-align:center;'>	".$li." <img src='../gfx/_staticPages/LogoMicrosoftEdgeChromium.png' border='0'>		".$lz."	</td>
<td style='text-align:center;'>	".$lo." <img src='../gfx/_staticPages/LogoOpera.png' border='0'>		".$lz."	</td>
</tr>
<tr>

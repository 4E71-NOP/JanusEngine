...
self::$PreRequisiteTable['add']['category'] = array (
		...
		"nextId" => array (
				array ("table" => "category",				"column" => "cate_id",			"target" => "id"),
		),
		"columns" => array(
				array ( "v" => "id",				"t" => "cate_id"),
				array ( "v" => "name",				"t" => "cate_name"),
...
self::$PreRequisiteTable['add']['layout_content'] = array (
		...
		"nextId" => array (
				array ("table" => "layout_content",	"column" => "lyoc_id",		"target" => "id"),
		),
		"columns" => array(
				...
				array ( "v" => "dimenssion_y",			"t" => "lyoc_size_y"),
				array ( "v" => "module_anchor_e1a",		"t" => "lyoc_module_anchor_e1a"),
				array ( "v" => "module_anchor_e1b",		"t" => "lyoc_module_anchor_e1b"),
				array ( "v" => "module_anchor_e1c",		"t" => "lyoc_module_anchor_e1c"),
				array ( "v" => "module_anchor_e1d",		"t" => "lyoc_module_anchor_e1d"),
				array ( "v" => "module_anchor_e1e",		"t" => "lyoc_module_anchor_e1e"),
				array ( "v" => "module_anchor_e2a",		"t" => "lyoc_module_anchor_e2a"),
				array ( "v" => "module_anchor_e2b",		"t" => "lyoc_module_anchor_e2b"),
				array ( "v" => "module_anchor_e2c",		"t" => "lyoc_module_anchor_e2c"),
				array ( "v" => "module_anchor_e2d",		"t" => "lyoc_module_anchor_e2d"),
				array ( "v" => "module_anchor_e2e",		"t" => "lyoc_module_anchor_e2e"),
				array ( "v" => "module_anchor_e3a",		"t" => "lyoc_module_anchor_e3a"),
				array ( "v" => "module_anchor_e3b",		"t" => "lyoc_module_anchor_e3b"),
				array ( "v" => "module_anchor_e3c",		"t" => "lyoc_module_anchor_e3c"),
				array ( "v" => "module_anchor_e3d",		"t" => "lyoc_module_anchor_e3d"),
				array ( "v" => "module_anchor_e3e",		"t" => "lyoc_module_anchor_e3e"),
				array ( "v" => "anchor_ex1a",			"t" => "lyoc_anchor_ex1a"),
				array ( "v" => "anchor_ey1a",			"t" => "lyoc_anchor_ey1a"),
				array ( "v" => "anchor_ex1b",			"t" => "lyoc_anchor_ex1b"),
				array ( "v" => "anchor_ey1b",			"t" => "lyoc_anchor_ey1b"),
				array ( "v" => "anchor_ex1c",			"t" => "lyoc_anchor_ex1c"),
				array ( "v" => "anchor_ey1c",			"t" => "lyoc_anchor_ey1c"),
				array ( "v" => "anchor_ex1d",			"t" => "lyoc_anchor_ex1d"),
				array ( "v" => "anchor_ey1d",			"t" => "lyoc_anchor_ey1d"),
				array ( "v" => "anchor_ex1e",			"t" => "lyoc_anchor_ex1e"),
				array ( "v" => "anchor_ey1e",			"t" => "lyoc_anchor_ey1e"),
				array ( "v" => "anchor_ex2a",			"t" => "lyoc_anchor_ex2a"),
				array ( "v" => "anchor_ey2a",			"t" => "lyoc_anchor_ey2a"),
				array ( "v" => "anchor_ex2b",			"t" => "lyoc_anchor_ex2b"),
				array ( "v" => "anchor_ey2b",			"t" => "lyoc_anchor_ey2b"),
				array ( "v" => "anchor_ex2c",			"t" => "lyoc_anchor_ex2c"),
				array ( "v" => "anchor_ey2c",			"t" => "lyoc_anchor_ey2c"),
				array ( "v" => "anchor_ex2d",			"t" => "lyoc_anchor_ex2d"),
				array ( "v" => "anchor_ey2d",			"t" => "lyoc_anchor_ey2d"),
				array ( "v" => "anchor_ex2e",			"t" => "lyoc_anchor_ex2e"),
				array ( "v" => "anchor_ey2e",			"t" => "lyoc_anchor_ey2e"),
				array ( "v" => "anchor_ex3a",			"t" => "lyoc_anchor_ex3a"),
				array ( "v" => "anchor_ey3a",			"t" => "lyoc_anchor_ey3a"),
				array ( "v" => "anchor_ex3b",			"t" => "lyoc_anchor_ex3b"),
				array ( "v" => "anchor_ey3b",			"t" => "lyoc_anchor_ey3b"),
				array ( "v" => "anchor_ex3c",			"t" => "lyoc_anchor_ex3c"),
				array ( "v" => "anchor_ey3c",			"t" => "lyoc_anchor_ey3c"),
				array ( "v" => "anchor_ex3d",			"t" => "lyoc_anchor_ex3d"),
				array ( "v" => "anchor_ey3d",			"t" => "lyoc_anchor_ey3d"),
				array ( "v" => "anchor_ex3e",			"t" => "lyoc_anchor_ex3e"),
				array ( "v" => "anchor_ey3e",			"t" => "lyoc_anchor_ey3e"),
				array ( "v" => "anchor_dx10",			"t" => "lyoc_anchor_dx10"),
				array ( "v" => "anchor_dy10",			"t" => "lyoc_anchor_dy10"),
				array ( "v" => "anchor_dx20",			"t" => "lyoc_anchor_dx20"),
				array ( "v" => "anchor_dy20",			"t" => "lyoc_anchor_dy20"),
				array ( "v" => "anchor_dx30",			"t" => "lyoc_anchor_dx30"),
				array ( "v" => "anchor_dy30",			"t" => "lyoc_anchor_dy30"),
				array ( "v" => "spacing_border_left",	"t" => "lyoc_margin_left"),
				array ( "v" => "spacing_border_right",	"t" => "lyoc_margin_right"),
				array ( "v" => "spacing_border_top",	"t" => "lyoc_margin_top"),
				array ( "v" => "spacing_border_bottom",	"t" => "lyoc_margin_bottom"),
				array ( "v" => "module_zindex",			"t" => "lyoc_module_zindex"),
		),
);

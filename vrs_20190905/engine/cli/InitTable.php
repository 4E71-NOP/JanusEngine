...
self::$InitTable['decoration'] = function (&$a) {
	$a['params'] = array(
		...
		"txt_font_size" => 	"14",
		"txt_font_name_normal" => 	"",
		"txt_font_filename_normal" => 	"",
		"txt_font_name_bold" => 	"",
		"txt_font_filename_bold" => 	"",
	...
	$a['listVars'] = array(
		"10" => array(
			...
			"target_dock",	
			"dock_decal_x",	"dock_decal_y",	
			"dock_smenu",	
			"icon_file_01",	
			"icon_file_02",	
			"icon_directory_01",	"icon_directory_02",	
			"icon_special_01",		"icon_special_02",	
		...
		"20" => array(
			...
			"p_mrg_top",				"p_mrg_bottom",				"p_mrg_left",						"p_mrg_right",						"p_pad_top",			"p_pad_bottom",	
			...
			"tab_down_txt_bg_col",
			"tab_down_txt_weight",
			"tab_down_txt_special",
			"tab_hover_txt_col",
			"tab_hover_txt_bg_col",
			"tab_hover_txt_weight",
			"tab_hover_txt_special",
			"tab_height",
			"tab_a_width",
			"tab_c_width",
			"tab_frame_bg_col",
		...
		"30" => array(
			...
			"border_top_width", "border_top_color", "border_top_style",
			"padding_top",
			"margin_top",
			"border_bottom_width", "border_bottom_color", "border_bottom_style",
			"padding_bottom",
			"margin_bottom",
			"border_left_width", "border_left_color", "border_left_style",
			"padding_left",
			"margin_left",
			"border_right_width", "border_right_color", "border_right_style",
			"padding_right",
			"margin_right",
			"border_all_width", "border_all_color", "border_all_style", 
			"padding_all",
			"margin_all"
		),
		"40" => array(

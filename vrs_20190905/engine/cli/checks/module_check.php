...
self::$CheckTable['add']['module']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(mdl.module_id)) AS module_id FROM " . $a['sqlTables']['module'] . " mdl , " . $a['sqlTables']['module_website'] . " sm WHERE mdl.module_name = '" . $a['params']['name'] . "' AND mdl.module_id = sm.fk_module_id AND sm.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
self::$CheckTable['add']['module']['0']['m']	= "CLI_Module_C001";
self::$CheckTable['add']['module']['0']['s']	= "name";

self::$CheckTable['add']['module']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['module']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(prm.perm_id)) AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['permission'] . "' ;");};
...
self::$CheckTable['update']['module']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['module']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(mdl.module_id)) AS module_id FROM " . $a['sqlTables']['module'] . " mdl , " . $a['sqlTables']['module_website'] . " sm WHERE mdl.module_name = '" . $a['params']['name'] . "' AND mdl.module_id = sm.fk_module_id AND sm.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['module']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['module']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(prm.perm_id)) AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['permission'] . "' ;");};
...
self::$CheckTable['delete']['module']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['module']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(mdl.module_id)) AS module_id FROM " . $a['sqlTables']['module'] . " mdl , " . $a['sqlTables']['module_website'] . " sm WHERE mdl.module_name = '" . $a['params']['name'] . "' AND mdl.module_id = sm.fk_module_id AND sm.fk_ws_id = " . $a['Context']['ws_id'] . ";");};

...
self::$CheckTable['add']['article']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id, arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
self::$CheckTable['add']['article']['0']['m']	= "CLI_Article_C001";
self::$CheckTable['add']['article']['0']['s']	= "name";
self::$CheckTable['add']['article']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['article']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(deadline_id)) AS deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['deadline'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['add']['article']['2']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['article']['2']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(config_id)) AS config_id FROM " . $a['sqlTables']['article_config'] . " WHERE config_name = '" . $a['params']['config'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['add']['article']['3']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['article']['3']['f']	= function ($a) {
	if (strlen($a['params']['creator']) == 0) {
		$a['params']['creator'] = $a['curent_user'];
	}
	return array("SELECT CONCAT('0x', HEX(usr.user_id)) AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['creator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = 1 AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['add']['article']['4']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['article']['4']['f']	= function ($a) {
	if (strlen($a['params']['validator']) == 0) {
		$a['params']['validator'] = $a['current_user'];
	}
	return array("SELECT CONCAT('0x', HEX(usr.user_id)) AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = 1 AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['article']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['article']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id, arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['article']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(deadline_id)) AS deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['deadline'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['article']['2']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(config_id)) AS config_id FROM " . $a['sqlTables']['article_config'] . " WHERE config_name = '" . $a['params']['config'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['article']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['article']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id, arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['link']['article']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['link']['article']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id, arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['link']['article']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['link']['article']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(doc.docu_id)) AS docu_id, doc.docu_name AS docu_name FROM " . $a['sqlTables']['document'] . " doc , " . $a['sqlTables']['document_share'] . " dp WHERE doc.docu_name = '" . $a['document'] . "' AND dp.fk_docu_id = doc.fk_docu_id AND dp.fk_ws_id = " . $a['Context']['ws_id'] . ";");};

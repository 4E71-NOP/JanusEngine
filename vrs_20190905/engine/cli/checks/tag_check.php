...
self::$CheckTable['add']['tag']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(tag_id)) AS tag_id,tag_name FROM " . $a['sqlTables']['tag'] . " WHERE tag_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['assign']['tag']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(tag_id)) AS tag_id,tag_name FROM " . $a['sqlTables']['tag'] . " WHERE tag_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['assign']['tag']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['article'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['assign']['tag']['2']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(fk_tag_id)) AS fk_tag_id FROM " . $a['sqlTables']['article_tag'] . " WHERE fk_tag_id = '" . $a['params']['tag_id'] . "' AND fk_arti_id = '" . $a['params']['arti_id'] . "';");};
...
self::$CheckTable['delete']['tag']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(tag_id)) AS tag_id,tag_name FROM " . $a['sqlTables']['tag'] . " WHERE BINARY tag_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};

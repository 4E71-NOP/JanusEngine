...
self::$CheckTable['add']['keyword']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['keyword']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['article'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['keyword']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['keyword']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(keyword_id)) AS keyword_id FROM " . $a['sqlTables']['keyword'] . " WHERE keyword_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['keyword']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['keyword']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['article'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['keyword']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['keyword']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(keyword_id)) AS keyword_id FROM " . $a['sqlTables']['keyword'] . " WHERE keyword_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};

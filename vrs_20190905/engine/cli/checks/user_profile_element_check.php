...
self::$CheckTable['add']['user_profile_element']['0']['f']		= function ($a) {return array("SELECT CONCAT('0x', HEX(upe_id)) AS upe_id,upe_name FROM " . $a['sqlTables']['user_profile_element'] . " WHERE upe_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
self::$CheckTable['add']['user_profile_element']['0']['m']		= "CLI_profile_element_A001";
self::$CheckTable['add']['user_profile_element']['0']['s']		= "name";

self::$CheckTable['update']['user_profile_element']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['user_profile_element']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(upe_id)) AS upe_id,upe_name FROM " . $a['sqlTables']['user_profile_element'] . " WHERE upe_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['user_profile_element']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['user_profile_element']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(upe_id)) AS upe_id,upe_name FROM " . $a['sqlTables']['user_profile_element'] . " WHERE upe_name = '" . $a['params']['name'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};

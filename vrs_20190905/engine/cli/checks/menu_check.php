...
self::$CheckTable['add']['menu']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(menu_id)) AS menu_id FROM " . $a['sqlTables']['menu'] . " WHERE fk_ws_id = " . $a['Context']['ws_id'] . " AND menu_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['add']['menu']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(menu_id)) AS menu_id FROM " . $a['sqlTables']['menu'] . " WHERE fk_ws_id = " . $a['Context']['ws_id'] . " AND menu_name = '" . $a['params']['parent'] . "';");};
...
self::$CheckTable['add']['menu']['2']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['menu']['2']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(deadline_id)) AS deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['deadline'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['add']['menu']['3']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['menu']['3']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(prm.perm_id)) AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['permission'] . "' ;");};
...
self::$CheckTable['add']['menu']['4']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['menu']['4']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(lang_id)) AS lang_id FROM " . $a['sqlTables']['language'] . " WHERE lang_639_3 = '" . $a['params']['lang'] . "';");};
...
self::$CheckTable['update']['menu']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['menu']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(menu_id)) AS menu_id FROM " . $a['sqlTables']['menu'] . " WHERE fk_ws_id = " . $a['Context']['ws_id'] . " AND menu_name = '" . $a['params']['name'] . "';");};

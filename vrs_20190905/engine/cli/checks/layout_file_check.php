...
self::$CheckTable['add']['layout_file']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_file_id)) AS layout_file_id,layout_file_name FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['name'] . "';");};
self::$CheckTable['add']['layout_file']['0']['m']	= "CLI_layout_file_D001";
self::$CheckTable['add']['layout_file']['0']['s']	= "name";

self::$CheckTable['update']['layout_file']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['layout_file']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_file_id)) AS layout_file_id,layout_file_name FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['delete']['layout_file']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['layout_file']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_file_id)) AS layout_file_id,layout_file_name FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['name'] . "';");};

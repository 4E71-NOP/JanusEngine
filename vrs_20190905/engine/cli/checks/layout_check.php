...
self::$CheckTable['add']['layout']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_id)) AS layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");};
self::$CheckTable['add']['layout']['0']['m']	= "CLI_Layout_C001";
self::$CheckTable['add']['layout']['0']['s']	= "name";
self::$CheckTable['add']['layout']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['layout']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_file_id)) AS layout_file_id FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['layout_file'] . "';");};
...
self::$CheckTable['update']['layout']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['layout']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_id)) AS layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['delete']['layout']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['layout']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_id)) AS layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['assign']['layout']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['layout']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(layout_id)) AS layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['assign']['layout']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['layout']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(sd.theme_id)) AS theme_id, sd.theme_name AS theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['to_theme'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = " . $a['Context']['ws_id'] . ";");};

...
self::$CheckTable['add']['group']['1']['d'] = _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['group']['1']['f'] = function ($a) {
	if ($a['params']['parent'] != 'origin') {
		return array("SELECT CONCAT('0x', HEX(grp.group_id)) AS group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['parent'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = " . $a['Context']['ws_id'] . ";");
	} else {
		return -1;
	}};
...
self::$CheckTable['update']['group']['0']['d'] = _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['group']['0']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(grp.group_id)) AS group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['group']['1']['d'] = _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['group']['1']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(grp.group_id)) AS group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['group']['0']['d'] = _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['group']['0']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(grp.group_id)) AS group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = " . $a['Context']['ws_id'] . ";");};

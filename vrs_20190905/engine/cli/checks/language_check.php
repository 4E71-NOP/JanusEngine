...
self::$CheckTable['assign']['language']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['language']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(ws_id)) AS ws_id,ws_name FROM " . $a['sqlTables']['website'] . " WHERE ws_name = '" . $a['params']['to_website'] . "';");};
...
self::$CheckTable['assign']['language']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['language']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(lang_id)) AS lang_id FROM " . $a['sqlTables']['language'] . " WHERE lang_639_3 = '" . $a['params']['name'] . "'");};

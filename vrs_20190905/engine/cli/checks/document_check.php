...
self::$CheckTable['add']['document']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(docu_id)) AS docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");};
self::$CheckTable['add']['document']['0']['m']	= "CLI_Document_C001";
self::$CheckTable['add']['document']['0']['s']	= "name";
self::$CheckTable['add']['document']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['document']['1']['f']	= function ($a) {return array("SELECT usr.user_login,CONCAT('0x', HEX(usr.user_id)) AS user_id FROM " . $a['sqlTables']['user'] . " usr , " . $a['sqlTables']['group_user'] . " gu , " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['creator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
// TODO use DISTINCT
self::$CheckTable['add']['document']['2']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['document']['2']['f']	= function ($a) {return array("SELECT usr.user_login,CONCAT('0x', HEX(usr.user_id)) AS user_id FROM " . $a['sqlTables']['user'] . " usr , " . $a['sqlTables']['group_user'] . " gu , " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['update']['document']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['document']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(docu_id)) AS docu_id, docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['update']['document']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['document']['1']['f']	= function ($a) {return array("SELECT usr.user_login,CONCAT('0x', HEX(usr.user_id)) AS user_id FROM " . $a['sqlTables']['user'] . " usr , " . $a['sqlTables']['group_user'] . " gu , " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['document']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['document']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(docu_id)) AS docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['share']['document']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['share']['document']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(docu_id)) AS docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['share']['document']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['share']['document']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(ws_id)) AS ws_id,ws_name FROM " . $a['sqlTables']['website'] . " WHERE ws_name = '" . $a['params']['with_website'] . "';");};
...
self::$CheckTable['share']['document']['2']['d'] 	= _FIND_DUPLICATE_;
self::$CheckTable['share']['document']['2']['f'] 	= function ($a) {return array("SELECT CONCAT('0x', HEX(share_id)) AS share_id FROM " . $a['sqlTables']['document_share'] . " WHERE fk_ws_id = '" . $a['params']['ws_id'] . "' AND fk_docu_id = '" . $a['params']['docu_id'] . "';");};
self::$CheckTable['share']['document']['2']['m'] 	= "CLI_ShareDocument_S003";
self::$CheckTable['share']['document']['2']['s'] 	= "docu_id";


self::$CheckTable['assign']['document']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['document']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(docu_id)) AS docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");};
...
self::$CheckTable['assign']['document']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['document']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(arti_id)) AS arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['to_article'] . "' AND fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['insert']['content']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['insert']['content']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(docu_id)) AS docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['into'] . "';");};
...
self::$CheckTable['insert']['content']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['insert']['content']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(usr.user_id)) AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['creator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['insert']['content']['2']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['insert']['content']['2']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(usr.user_id)) AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = " . $a['Context']['ws_id'] . ";");};

...
self::$CheckTable['add']['extension']['0']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(e.ext_id)) AS ext_id FROM " . $a['sqlTables']['extension'] . " e WHERE e.ext_name = '" . $a['params']['name'] . "' AND e.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['extension']['0']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(e.ext_id)) AS ext_id, e.ext_name FROM " . $a['sqlTables']['extension'] . " e WHERE e.ext_name = '" . $a['params']['name'] . "' AND e.fk_ws_id = " . $a['Context']['ws_id'] . ";");};

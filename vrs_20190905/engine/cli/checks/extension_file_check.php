...
self::$CheckTable['add']['extension_file']['0']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(extfil_id)) AS extfil_id FROM " . $a['sqlTables']['extension_file'] . " WHERE extfil_generic_name = '" . $a['params']['generic_name'] . "';");};
self::$CheckTable['add']['extension_file']['0']['m'] = "CLI_extension_file_C001";
self::$CheckTable['add']['extension_file']['0']['s'] = "name";
self::$CheckTable['add']['extension_file']['1']['d'] = _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['extension_file']['1']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(ext_id)) AS ext_id FROM " . $a['sqlTables']['extension'] . " WHERE ext_name = '" . $a['params']['extension'] . "';");};
...
self::$CheckTable['delete']['extension_file']['0']['d'] = _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['extension_file']['0']['f'] = function ($a) {return array("SELECT CONCAT('0x', HEX(e.extfil_id)) AS extfil_id FROM " . $a['sqlTables']['extension_file'] . " e WHERE e.extfil_name = '" . $a['params']['name'] . "';");};

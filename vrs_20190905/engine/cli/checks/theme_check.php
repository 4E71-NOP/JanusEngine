...
self::$CheckTable['add']['theme']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(sd.theme_id)) AS theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
self::$CheckTable['add']['theme']['0']['m']	= "CLI_Theme_C001";
self::$CheckTable['add']['theme']['0']['s']	= "name";
self::$CheckTable['update']['theme']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['theme']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(sd.theme_id)) AS theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['theme']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['theme']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(sd.theme_id)) AS theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['assign']['theme']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['theme']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(sd.theme_id)) AS theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['assign']['theme']['1']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['assign']['theme']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(ws_id)) AS ws_id FROM " . $a['sqlTables']["website"] . " WHERE ws_name = '" . $a['params']['to_website'] . "' ;");};

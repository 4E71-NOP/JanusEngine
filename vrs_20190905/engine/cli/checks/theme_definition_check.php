...
self::$CheckTable['add']['theme_definition']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['add']['theme_definition']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(td.theme_id)) AS theme_id, td.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " ws WHERE td.theme_name = '" . $a['params']['for_theme'] . "' AND td.theme_id = ws.fk_theme_id AND ws.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['add']['theme_definition']['1']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(tdf.def_id)) AS def_id, tdf.def_name FROM " . $a['sqlTables']['theme_definition'] . " tdf, " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " tw WHERE tdf.def_name = '" . $a['params']['name'] . "' AND td.theme_name = '" . $a['params']['for_theme'] . "' AND tdf.fk_theme_id = td.theme_id AND td.theme_id = tw.fk_theme_id AND tw.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
self::$CheckTable['add']['theme_definition']['1']['m']	= "CLI_Theme_definition_C001";
self::$CheckTable['add']['theme_definition']['1']['s']	= "name";
self::$CheckTable['update']['theme_definition']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['update']['theme_definition']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(tdf.def_id)) AS def_id, tdf.def_name FROM " . $a['sqlTables']['theme_definition'] . " tdf, " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " tw WHERE tdf.def_name = '" . $a['params']['name'] . "' AND tdf.fk_theme_id = td.theme_id AND td.theme_id = tw.fk_theme_id AND tdf.fk_theme_id = '" . $a['params']['fk_theme_id'] . "' AND tw.fk_ws_id = " . $a['Context']['ws_id'] . ";");};
...
self::$CheckTable['delete']['theme_definition']['0']['d']	= _RETURN_DATA_AND_ERROR_;
self::$CheckTable['delete']['theme_definition']['0']['f']	= function ($a) {return array("SELECT CONCAT('0x', HEX(tdf.def_id)) AS def_id, tdf.def_name FROM " . $a['sqlTables']['theme_definition'] . " tdf, " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " tw WHERE tdf.def_name = '" . $a['params']['name'] . "' AND tdf.fk_theme_id = td.theme_id AND td.theme_id = tw.fk_theme_id AND tdf.fk_theme_id = '" . $a['params']['fk_theme_id'] . "' AND tw.fk_ws_id = " . $a['Context']['ws_id'] . ";");};

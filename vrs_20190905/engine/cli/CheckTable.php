...
self::$CheckTable['add']['article']['0']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
self::$CheckTable['add']['article']['0']['m']	= "CLI_Article_C001";
self::$CheckTable['add']['article']['0']['s']	= "name";
self::$CheckTable['add']['article']['1']['d']	= 2;
self::$CheckTable['add']['article']['1']['f']	= function ($a) {
	return array("SELECT deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['deadline'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['article']['2']['f']	= function ($a) {
	return array("SELECT config_id FROM " . $a['sqlTables']['article_config'] . " WHERE config_name = '" . $a['params']['config'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['article']['0']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['article']['1']['f']	= function ($a) {
	return array("SELECT deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['deadline'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['article']['2']['f']	= function ($a) {
	return array("SELECT config_id FROM " . $a['sqlTables']['article_config'] . " WHERE config_name = '" . $a['params']['config'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['article']['0']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['link']['article']['0']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['link']['article']['1']['f']	= function ($a) {
	return array("SELECT doc.docu_id AS docu_id, doc.docu_name AS docu_name FROM " . $a['sqlTables']['document'] . " doc , " . $a['sqlTables']['document_share'] . " dp WHERE doc.docu_name = '" . $a['document'] . "' AND dp.fk_docu_id = doc.fk_docu_id AND dp.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['insert']['content']['0']['f']	= function ($a) {
	return array("SELECT docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['into'] . "';");
};
...
self::$CheckTable['insert']['content']['1']['f']	= function ($a) {
	return array("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['creator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['insert']['content']['2']['f']	= function ($a) {
	return array("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['deadline']['0']['f']	= function ($a) {
	return array("SELECT deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['deadline']['0']['f']	= function ($a) {
	return array("SELECT deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['deadline']['0']['f']	= function ($a) {
	return array("SELECT deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['decoration']['0']['f']	= function ($a) {
	return array("SELECT deco_name FROM " . $a['sqlTables']['decoration'] . " WHERE deco_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['article_config']['0']['f']	= function ($a) {
	return array("SELECT config_id FROM " . $a['sqlTables']['article_config'] . " WHERE config_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['definition']['1']['f']	= function ($a) {
	return array("SELECT def.def_id  FROM " . $a['sqlTables']['definition'] . " def WHERE def.def_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['document']['0']['f']	= function ($a) {
	return array("SELECT docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['document']['1']['f']	= function ($a) {
	return array("SELECT usr.user_login,usr.user_id  FROM " . $a['sqlTables']['user'] . " usr , " . $a['sqlTables']['group_user'] . " gu , " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['creator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['document']['2']['f']	= function ($a) {
	return array("SELECT usr.user_login,usr.user_id  FROM " . $a['sqlTables']['user'] . " usr , " . $a['sqlTables']['group_user'] . " gu , " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['document']['0']['f']	= function ($a) {
	return array("SELECT docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['update']['document']['1']['f']	= function ($a) {
	return array("SELECT usr.user_login,usr.user_id  FROM " . $a['sqlTables']['user'] . " usr , " . $a['sqlTables']['group_user'] . " gu , " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['validator'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['document']['0']['f']	= function ($a) {
	return array("SELECT docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['share']['document']['0']['f']	= function ($a) {
	return array("SELECT docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['share']['document']['1']['f']	= function ($a) {
	return array("SELECT ws_id,ws_name FROM " . $a['sqlTables']['website'] . " WHERE ws_name = '" . $a['params']['with_website'] . "';");
};
...
self::$CheckTable['share']['document']['2']['f'] 	= function ($a) {
	return array("SELECT share_id FROM " . $a['sqlTables']['document_share'] . " WHERE fk_ws_id = '" . $a['params']['ws_id'] . "' AND fk_docu_id = '" . $a['params']['docu_id'] . "';");
};
...
self::$CheckTable['assign']['document']['0']['f']	= function ($a) {
	return array("SELECT docu_id,docu_name FROM " . $a['sqlTables']['document'] . " WHERE docu_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['assign']['document']['1']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['to_article'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['group']['0']['f'] = function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['group']['0']['f'] = function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['group']['1']['f'] = function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['group']['0']['f'] = function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['name'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['keyword']['0']['f']	= function ($a) {
	return array("SELECT keyword_id FROM " . $a['sqlTables']['keyword'] . " WHERE keyword_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
self::$CheckTable['add']['keyword']['0']['m']	= "CLI_KeyWord_C001";
self::$CheckTable['add']['keyword']['0']['s']	= "name";
self::$CheckTable['add']['keyword']['1']['d']	= 2;
self::$CheckTable['add']['keyword']['1']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['article'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['keyword']['0']['f']	= function ($a) {
	return array("SELECT keyword_id FROM " . $a['sqlTables']['keyword'] . " WHERE keyword_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['keyword']['1']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['article'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['keyword']['0']['f']	= function ($a) {
	return array("SELECT keyword_id FROM " . $a['sqlTables']['keyword'] . " WHERE keyword_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['language']['0']['f']	= function ($a) {
	return array("SELECT ws_id,ws_name FROM " . $a['sqlTables']['website'] . " WHERE ws_name = '" . $a['params']['to_website'] . "';");
};
...
self::$CheckTable['assign']['language']['1']['f']	= function ($a) {
	return array("SELECT lang_id FROM " . $a['sqlTables']['language'] . " WHERE lang_639_3 = '" . $a['params']['name'] . "'");
};
...
self::$CheckTable['add']['layout']['0']['f']	= function ($a) {
	return array("SELECT layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");
};
self::$CheckTable['add']['layout']['0']['m']	= "CLI_Layout_C001";
self::$CheckTable['add']['layout']['0']['s']	= "name";
self::$CheckTable['add']['layout']['0']['d']	= 2;
self::$CheckTable['add']['layout']['0']['f']	= function ($a) {
	return array("SELECT layout_file_id FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['layout_file'] . "';");
};
...
self::$CheckTable['update']['layout']['0']['f']	= function ($a) {
	return array("SELECT layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['delete']['layout']['0']['f']	= function ($a) {
	return array("SELECT layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['assign']['layout']['0']['f']	= function ($a) {
	return array("SELECT layout_id,layout_name FROM " . $a['sqlTables']['layout'] . " WHERE layout_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['assign']['layout']['1']['f']	= function ($a) {
	return array("SELECT sd.theme_id AS theme_id, sd.theme_name AS theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['to_theme'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['layout_file']['0']['f']	= function ($a) {
	return array("SELECT layout_file_id,layout_file_name FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['update']['layout_file']['0']['f']	= function ($a) {
	return array("SELECT layout_file_id,layout_file_name FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['delete']['layout_file']['0']['f']	= function ($a) {
	return array("SELECT layout_file_id,layout_file_name FROM " . $a['sqlTables']['layout_file'] . " WHERE layout_file_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['menu']['0']['f']	= function ($a) {
	return array("SELECT menu_id FROM " . $a['sqlTables']['menu'] . " WHERE fk_ws_id = '" . $a['Context']['ws_id'] . "' AND menu_name = '" . $a['params']['name'] . "';");
};
self::$CheckTable['add']['menu']['0']['m']	= "CLI_menu_C001";
self::$CheckTable['add']['menu']['0']['s']	= "name";
self::$CheckTable['add']['menu']['1']['d']	= 1;
self::$CheckTable['add']['menu']['1']['f']	= function ($a) {
	return array("SELECT menu_id FROM " . $a['sqlTables']['menu'] . " WHERE fk_ws_id = '" . $a['Context']['ws_id'] . "' AND menu_name = '" . $a['params']['parent'] . "';");
};
...
self::$CheckTable['add']['menu']['2']['f']	= function ($a) {
	return array("SELECT deadline_id FROM " . $a['sqlTables']['deadline'] . " WHERE deadline_name = '" . $a['params']['deadline'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['menu']['3']['f']	= function ($a) {
	return array("SELECT prm.perm_id AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['permission'] . "' ;");
};
...
self::$CheckTable['add']['menu']['4']['f']	= function ($a) {
...
self::$CheckTable['update']['menu']['0']['f']	= function ($a) {
	return array("SELECT menu_id FROM " . $a['sqlTables']['menu'] . " WHERE fk_ws_id = '" . $a['Context']['ws_id'] . "' AND menu_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['module']['0']['f']	= function ($a) {
	return array("SELECT mdl.module_id FROM " . $a['sqlTables']['module'] . " mdl , " . $a['sqlTables']['module_website'] . " sm WHERE mdl.module_name = '" . $a['params']['name'] . "' AND mdl.module_id = sm.fk_module_id AND sm.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
self::$CheckTable['add']['module']['0']['m']	= "CLI_Module_C001";
self::$CheckTable['add']['module']['0']['s']	= "name";

self::$CheckTable['add']['module']['1']['d']	= 2;
self::$CheckTable['add']['module']['1']['f']	= function ($a) {
	return array("SELECT prm.perm_id AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['permission'] . "' ;");
};
...
self::$CheckTable['update']['module']['0']['f']	= function ($a) {
	return array("SELECT mdl.module_id FROM " . $a['sqlTables']['module'] . " mdl , " . $a['sqlTables']['module_website'] . " sm WHERE mdl.module_name = '" . $a['params']['name'] . "' AND mdl.module_id = sm.fk_module_id AND sm.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['module']['1']['f']	= function ($a) {
	return array("SELECT prm.perm_id AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['permission'] . "' ;");
};
...
self::$CheckTable['delete']['module']['0']['f']	= function ($a) {
	return array("SELECT mdl.module_id FROM " . $a['sqlTables']['module'] . " mdl , " . $a['sqlTables']['module_website'] . " sm WHERE mdl.module_name = '" . $a['params']['name'] . "' AND mdl.module_id = sm.fk_module_id AND sm.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['permission']['0']['f']	= function ($a) {
	return array("SELECT prm.perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['tag']['0']['f']	= function ($a) {
	return array("SELECT tag_id,tag_name FROM " . $a['sqlTables']['tag'] . " WHERE tag_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
self::$CheckTable['add']['tag']['0']['m']	= "CLI_Tag_C001";
self::$CheckTable['add']['tag']['0']['s']	= "name";

self::$CheckTable['assign']['tag']['0']['d']	= 2;
self::$CheckTable['assign']['tag']['0']['f']	= function ($a) {
	return array("SELECT tag_id,tag_name FROM " . $a['sqlTables']['tag'] . " WHERE tag_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['tag']['1']['f']	= function ($a) {
	return array("SELECT arti_id,arti_name FROM " . $a['sqlTables']['article'] . " WHERE arti_name = '" . $a['params']['article'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['tag']['2']['f']	= function ($a) {
	return array("SELECT fk_tag_id FROM " . $a['sqlTables']['article_tag'] . " WHERE fk_tag_id = '" . $a['params']['tag_id'] . "' AND fk_arti_id = '" . $a['params']['arti_id'] . "';");
};
...
self::$CheckTable['delete']['tag']['0']['f']	= function ($a) {
	return array("SELECT tag_id,tag_name FROM " . $a['sqlTables']['tag'] . " WHERE BINARY tag_name = '" . $a['params']['name'] . "' AND fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['theme']['0']['f']	= function ($a) {
	return array("SELECT sd.theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
self::$CheckTable['add']['theme']['0']['m']	= "CLI_Theme_C001";
self::$CheckTable['add']['theme']['0']['s']	= "name";
self::$CheckTable['update']['theme']['0']['d']	= 2;
self::$CheckTable['update']['theme']['0']['f']	= function ($a) {
	return array("SELECT sd.theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['theme']['0']['f']	= function ($a) {
	return array("SELECT sd.theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['theme_definition']['0']['f']	= function ($a) {
	return array("SELECT td.theme_id, td.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " ws WHERE td.theme_name = '" . $a['params']['for_theme'] . "' AND td.theme_id = ws.fk_theme_id AND ws.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['theme_definition']['1']['f']	= function ($a) {
	return array("SELECT tdf.def_id, tdf.def_name FROM " . $a['sqlTables']['theme_definition'] . " tdf, " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " tw WHERE tdf.def_name = '" . $a['params']['name'] . "' AND td.theme_name = '" . $a['params']['for_theme'] . "' AND tdf.fk_theme_id = td.theme_id AND td.theme_id = tw.fk_theme_id AND tw.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['theme_definition']['0']['f']	= function ($a) {
	return array("SELECT tdf.def_id, tdf.def_name FROM " . $a['sqlTables']['theme_definition'] . " tdf, " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " tw WHERE tdf.def_name = '" . $a['params']['name'] . "' AND td.theme_name = '" . $a['params']['for_theme'] . "' AND tdf.fk_theme_id = td.theme_id AND td.theme_id = tw.fk_theme_id AND tw.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['delete']['theme_definition']['0']['f']	= function ($a) {
	return array("SELECT tdf.def_id, tdf.def_name FROM " . $a['sqlTables']['theme_definition'] . " tdf, " . $a['sqlTables']['theme_descriptor'] . " td, " . $a['sqlTables']['theme_website'] . " tw WHERE tdf.def_name = '" . $a['params']['name'] . "' AND td.theme_name = '" . $a['params']['for_theme'] . "' AND tdf.fk_theme_id = td.theme_id AND td.theme_id = tw.fk_theme_id AND tw.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['theme']['0']['f']	= function ($a) {
	return array("SELECT sd.theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['name'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['theme']['1']['f']	= function ($a) {
	return array("SELECT * FROM " . $a['sqlTables']["website"] . " WHERE ws_name = '" . $a['params']['to_website'] . "' ;");
};
...
self::$CheckTable['add']['translation']['0']['f']	= function ($a) {
	return array("SELECT lang_id FROM " . $a['sqlTables']['language'] . " WHERE lang_639_3 = '" . $a['params']['lang'] . "'");
};
...
self::$CheckTable['add']['translation']['1']['f']	= function ($a) {
	return array("SELECT * FROM " . $a['sqlTables']['i18n'] . " WHERE fk_lang_id = '" . $a['params']['lang_id'] . "' AND i18n_package = '" . $a['params']['package'] . "' AND i18n_name = '" . $a['params']['name'] . "';");
};
...
self::$CheckTable['add']['user']['0']['f']	= function ($a) {
	return array("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['name'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
self::$CheckTable['add']['user']['0']['m']	= "CLI_User_C001";
self::$CheckTable['add']['user']['0']['s']	= "name";
self::$CheckTable['add']['user']['1']['d']	= 2;
self::$CheckTable['add']['user']['1']['f']	= function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = 'Reader' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['add']['user']['2']['f']	= function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = 'Anonymous' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['update']['user']['3']['f']	= function ($a) {
	return array("SELECT t.theme_id, t.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " t, " . $a['sqlTables']['theme_website'] . " st WHERE t.theme_name = '" . $a['params']['pref_theme'] . "' AND t.theme_id = st.fk_theme_id AND st.theme_state = '1' AND st.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['group_permission']['0']['f']	= function ($a) {
	return array("SELECT prm.perm_id AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['name'] . "' ;");
};
...
self::$CheckTable['assign']['group_permission']['1']['f']	= function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['to_group'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['user_permission']['0']['f']	= function ($a) {
	return array("SELECT prm.perm_id AS perm_id FROM " . $a['sqlTables']['permission'] . " prm WHERE prm.perm_name = '" . $a['params']['name'] . "' ;");
};
...
self::$CheckTable['assign']['user_permission']['1']['f']	= function ($a) {
	return array("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['to_user'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['user']['0']['f']	= function ($a) {
	return array("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM " . $a['sqlTables']['user'] . " usr, " . $a['sqlTables']['group_user'] . " gu, " . $a['sqlTables']['group_website'] . " sg WHERE usr.user_login = '" . $a['params']['name'] . "' AND usr.user_id = gu.fk_user_id AND gu.fk_group_id = sg.fk_group_id AND gu.group_user_initial_group = '1' AND sg.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['user']['1']['f']	= function ($a) {
	return array("SELECT grp.group_id FROM " . $a['sqlTables']['group'] . " grp , " . $a['sqlTables']['group_website'] . " sg , " . $a['sqlTables']['website'] . " ws WHERE grp.group_name = '" . $a['params']['to_group'] . "' AND grp.group_id = sg.fk_group_id AND sg.fk_ws_id = ws.ws_id AND ws.ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['assign']['user']['2']['f']	= function ($a) {
	return array("SELECT group_user_id, fk_group_id, fk_user_id, group_user_initial_group FROM " . $a['sqlTables']['group_user'] . " WHERE fk_group_id = '" . $a['params']['group_id'] . "' AND fk_user_id = '" . $a['params']['user_id'] . "';");
};
...
self::$CheckTable['add']['website']['0']['f']	= function ($a) {
	return array("SELECT ws_id,ws_name FROM " . $a['sqlTables']['website'] . " WHERE ws_name = '" . $a['params']['name'] . "';");
};
self::$CheckTable['add']['website']['0']['m']	= "CLI_Website_C001";
self::$CheckTable['add']['website']['0']['s']	= "name";
self::$CheckTable['add']['website']['1']['d']	= 2;
self::$CheckTable['add']['website']['1']['f']	= function ($a) {
	return array("SELECT lang_id FROM " . $a['sqlTables']['language'] . " WHERE lang_639_3 = '" . $a['params']['lang'] . "'");
};
...
self::$CheckTable['update']['website']['1']['f']	= function ($a) {
	return array("SELECT lang_id FROM " . $a['sqlTables']['language'] . " WHERE lang_639_3 = '" . $a['params']['lang'] . "';");
};
...
self::$CheckTable['update']['website']['2']['f']	= function ($a) {
	return array("SELECT sd.theme_id, sd.theme_name FROM " . $a['sqlTables']['theme_descriptor'] . " sd, " . $a['sqlTables']['theme_website'] . " ss WHERE sd.theme_name = '" . $a['params']['theme'] . "' AND sd.theme_id = ss.fk_theme_id AND ss.fk_ws_id = '" . $a['Context']['ws_id'] . "';");
};
...
self::$CheckTable['website']['context']['0']['f']	= function ($a) {
	return array("SELECT * FROM " . $a['sqlTables']["website"] . " WHERE ws_name = '" . $a['params']['name'] . "' ;");
};

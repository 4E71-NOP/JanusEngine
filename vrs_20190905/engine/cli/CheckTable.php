...
self::$CheckTable['add']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['article']['0']['m']	= "CLI_Article_C001";
self::$CheckTable['add']['article']['0']['s']	= "name";
self::$CheckTable['add']['article']['1']['d']	= 2;
self::$CheckTable['add']['article']['1']['f']	= function ($a) { return array ("SELECT deadline_id FROM ".$a['sqlTables']['deadline']." WHERE deadline_name = '".$a['params']['deadline']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['article']['2']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_name = '".$a['params']['config']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['article']['3']['f']	= function ($a) { if ( strlen($a['params']['creator']) == 0 ) { $a['params']['creator'] = $a['curent_user']; } return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['group_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE user_login = '".$a['params']['creator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['article']['4']['f']	= function ($a) { if ( strlen($a['params']['validator']) == 0 ) { $a['params']['validator'] = $a['current_user']; } return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['group_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['1']['f']	= function ($a) { return array ("SELECT deadline_id FROM ".$a['sqlTables']['deadline']." WHERE deadline_name = '".$a['params']['deadline']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['2']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_name = '".$a['params']['config']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['3']['f']	= function ($a) { return array ("SELECT usr.layout_id AS layout_id, usr.layout_generic_name AS layout_generic_name FROM ".$a['sqlTables']['layout']." usr , ".$a['sqlTables']['layout_theme']." sp WHERE layout_generic_name = '".$a['params']['layout_generic_name']."' AND usr.layout_id = sp.layout_id AND sp.theme_id = '".$a['params']['theme_id']."';");};
...
self::$CheckTable['delete']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['link']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['link']['article']['1']['f']	= function ($a) { return array ("SELECT doc.docu_id AS docu_id, doc.docu_name AS docu_name FROM ".$a['sqlTables']['document']." doc , ".$a['sqlTables']['document_share']." dp WHERE doc.docu_name = '".$a['document']."' AND dp.docu_id = doc.docu_id AND dp.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['2']['f']	= function ($a) { return array ("SELECT deadline_id FROM ".$a['sqlTables']['deadline']." WHERE deadline_name = '".$a['params']['deadline']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['3']['f']	= function ($a) { return array ("SELECT grp.group_name, grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg  WHERE sg.ws_id = '".$a['Context']['ws_id']."' AND grp.group_name = '".$a['params']['group_name']."' AND grp.group_id = sg.group_id;");};
...
self::$CheckTable['insert']['content']['1']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['group_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['creator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['insert']['content']['2']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['group_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['deadline']['0']['f']	= function ($a) { return array ("SELECT deadline_id FROM ".$a['sqlTables']['deadline']." WHERE deadline_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['deadline']['0']['f']	= function ($a) { return array ("SELECT deadline_id FROM ".$a['sqlTables']['deadline']." WHERE deadline_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['deadline']['0']['f']	= function ($a) { return array ("SELECT deadline_id FROM ".$a['sqlTables']['deadline']." WHERE deadline_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document_config']['0']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_name = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document']['1']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['group_user']." gu , ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['creator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document']['2']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['group_user']." gu , ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['document']['1']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['group_user']." gu , ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['share']['document']['2']['f'] 	= function ($a) { return array ("SELECT share_id FROM ".$a['sqlTables']['document_share']." WHERE ws_id = '".$a['params']['ws_id']."' AND docu_id = '".$a['params']['docu_id']."';" ); };
...
self::$CheckTable['assign']['document']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['to_article']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
self::$CheckTable['add']['group']['0']['m'] = "CLI_group_C001";
self::$CheckTable['add']['group']['0']['s'] = "name";

self::$CheckTable['add']['group']['1']['d'] = 2;
self::$CheckTable['add']['group']['1']['f'] = function ($a) { if ($a['params']['parent'] != 'origin' ) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['parent']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" );} else { return -1; }};
...
self::$CheckTable['update']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['group']['1']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['delete']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['keyword']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['article']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['layout']['1']['f']	= function ($a) { return array ("SELECT sd.theme_id AS theme_id, sd.theme_name AS theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['theme_website']." ss WHERE sd.theme_name = '".$a['params']['to_theme']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['module']['0']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['module_website']." sm WHERE mdl.module_name = '".$a['params']['name']."' AND mdl.module_id = sm.module_id AND sm.ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['module']['0']['m']	= "CLI_Module_C001";
self::$CheckTable['add']['module']['0']['s']	= "name";
self::$CheckTable['add']['module']['1']['d']	= 2;
self::$CheckTable['add']['module']['1']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['group']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_see']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['module']['2']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['group']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_use']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['0']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['module_website']." sm WHERE mdl.module_name = '".$a['params']['name']."' AND mdl.module_id = sm.module_id AND sm.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['1']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['group']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_see']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['2']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['group']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_use']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['module']['0']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['module_website']." sm WHERE mdl.module_name = '".$a['params']['name']."' AND mdl.module_id = sm.module_id AND sm.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['tag']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_name FROM ".$a['sqlTables']['article']." WHERE arti_name = '".$a['params']['article']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['theme_website']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['theme']['0']['m']	= "CLI_Theme_C001";
self::$CheckTable['add']['theme']['0']['s']	= "name";

self::$CheckTable['update']['theme']['0']['d']	= 2;
self::$CheckTable['update']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['theme_website']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['theme_website']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['theme_website']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['user']['0']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['group_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['name']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['user']['0']['m']	= "CLI_User_C001";
self::$CheckTable['add']['user']['0']['s']	= "name";
self::$CheckTable['add']['user']['1']['d']	= 2;
self::$CheckTable['add']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = 'reader' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['user']['2']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = 'anonymous' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['0']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['group_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['name']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['group']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['to_group']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['2']['f']	= function ($a) { return array ( "SELECT group_user_id, group_id, user_id, group_user_initial_group FROM ".$a['sqlTables']['group_user']." WHERE group_id = '".$a['group_id']."' AND user_id = '".$a['user_id']."';" ); };

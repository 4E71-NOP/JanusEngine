...
// Categorie
self::$SqlQueryTable['M_CATEGO_rdc']['requete']		= "SELECT cate_id FROM ".$SqlTableListObj->getSQLTableName('menu')." WHERE ws_id = '".$webSiteId."' AND cate_name = '<A1>';";
self::$SqlQueryTable['M_CATEGO_rdc']['element']		= "Categorie";
self::$SqlQueryTable['M_CATEGO_rep']['requete']		= "SELECT cate_id FROM ".$SqlTableListObj->getSQLTableName('menu')." WHERE ws_id = '".$webSiteId."' AND cate_name = '<A1>';";
...
self::$SqlQueryTable['M_CATEGO_rrp']['requete']		= "SELECT cate_id FROM ".$SqlTableListObj->getSQLTableName('menu')." WHERE ws_id = '".$webSiteId."' AND cate_role = '2' AND cate_lang = '".$A['Context']['ws_lang']."';";

...
function genere_onglet_html () {
	...
	$GeneratedJavaScriptObj->insertJavaScript('Onload', "\tInitOnglets ( OngletData_".$tab_infos['groupe'].$tab_infos['cell_id'].$tab_infos['document']." );");
	$GeneratedJavaScriptObj->insertJavaScript('Data', $pv['JavaScriptTable']);

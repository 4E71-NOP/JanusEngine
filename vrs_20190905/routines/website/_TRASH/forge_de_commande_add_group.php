...
/*Hydre-licence-fin*/
$ligne++;
$tampon_commande_buffer[$ligne] = "add groupe name \"".$_REQUEST['M_GROUPE']['nom']. "\"	\n";
if ( strlen($_REQUEST['M_GROUPE']['parent']) > 0 )		{ $tampon_commande_buffer[$ligne] .= "parent	\"".$_REQUEST['M_GROUPE']['parent']."\"	\n";}
if ( strlen($_REQUEST['M_GROUPE']['titre']) > 0 )		{ $tampon_commande_buffer[$ligne] .= "title		\"".$_REQUEST['M_GROUPE']['titre']."\"	\n";}

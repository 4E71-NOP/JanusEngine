...
//	Creation
		case 1: 
			...
			if ( $R['ERR'] != 1 ) {
				...
				$R['id'] = manipulation_trouve_id_suivant ( $SqlTableListObj->getSQLTableName('groupe') , "groupe_id" );
				...
				$requete1 = "INSERT INTO ".$SqlTableListObj->getSQLTableName('groupe')." VALUES ".$requete_valeurs.";";

				$R['id2'] = manipulation_trouve_id_suivant ( $SqlTableListObj->getSQLTableName('site_groupe') , "site_groupe_id" );
				$requete2 = "
				INSERT INTO ".$SqlTableListObj->getSQLTableName('site_groupe')." VALUES ( 
				'".$R['id2']."',
...
//	Modification
		case 2:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$requete1 = "UPDATE ".$SqlTableListObj->getSQLTableName('groupe')." SET ".$requete_colonne." WHERE groupe_id = '".$R['id']."';";
				manipulation_traitement_requete ( $requete1 );
...
//	Suppresion
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				$requete1 = "UPDATE ".$SqlTableListObj->getSQLTableName('site_groupe')." 
				SET groupe_etat = '2' 
...
//	show
		case 5:
			...
			if ( $R['nom'] == "Nouveau groupe" ) {
				...
				FROM ".$SqlTableListObj->getSQLTableName('groupe')." as grp , ".$SqlTableListObj->getSQLTableName('site_groupe')." as sg 

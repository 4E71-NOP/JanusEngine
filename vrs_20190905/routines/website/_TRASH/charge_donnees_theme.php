...
$LMObj->logCheckpoint("charge_donnes_theme");
$MapperObj->RemoveThisLevel($localisation );
$MapperObj->setSqlApplicant("Chargement des donnees du theme");
...
if ( $theme_tableau == "theme_princ_" ) {
	...
	else { $Theme_actuel = $WebSiteObj->getWebSiteEntry('theme_id'); }			// cas d'un probleme avec le theme préféré par l'utilisateur.
}
...
//	"Yo dawg i heard you like admin goofing so i put an admin goof in yo admin goof..."
// --------------------------------------------------------------------------------------------

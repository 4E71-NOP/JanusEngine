...
//	Creation de theme
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				$R['theme_id'] = manipulation_trouve_id_suivant ( $SqlTableListObj->getSQLTableName('theme_descripteur') , "theme_id" );
				...
				$requete1 = "INSERT INTO ".$SqlTableListObj->getSQLTableName('theme_descripteur')." VALUES ".$requete_valeurs.";";

				$R['id2'] = manipulation_trouve_id_suivant ( $SqlTableListObj->getSQLTableName('site_theme') , "site_theme_id" );
				$requete2 = "
				INSERT INTO ".$SqlTableListObj->getSQLTableName('site_theme')." VALUES ( 
				'".$R['id2']."',
...
//	Modification de theme
		case 2:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$requete1 = "UPDATE ".$SqlTableListObj->getSQLTableName('theme_descripteur')." SET ".$requete_colonne." WHERE theme_id = '".$R['id']."';";
				manipulation_traitement_requete ( $requete1 );
...
//	Suppression de theme
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				$requete1 = "
				DELETE ".$SqlTableListObj->getSQLTableName('theme_descripteur')." 
...
//		show
		case 5:
			...
			if ( $R['nom'] == "Nouvelle theme" ) {
				...
				SELECT tm.theme_nom 
				FROM ".$SqlTableListObj->getSQLTableName('theme_descripteur')." AS tm, ".$SqlTableListObj->getSQLTableName('site_theme')." AS ss 

...
//		Creation de article_config
		case 1:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$R['id'] = manipulation_trouve_id_suivant ( $SqlTableListObj->getSQLTableName('article_config') , "config_id" );
				...
				$requete1 = "INSERT INTO ".$SqlTableListObj->getSQLTableName('article_config')." VALUES ".$requete_valeurs.";";
...
//		Modification
		case 2:
			...
			if ( $R['ERR'] != 1 ) {
				...
				$requete1 = "UPDATE ".$SqlTableListObj->getSQLTableName('article_config')." SET ".$requete_colonne." WHERE config_id = '".$R['id']."';";
				manipulation_traitement_requete ( $requete1 );
...
//		Suppression
		case 3:
			...
			if ( $R['ERR'] != 1 ) {
				$requete1 = "
				DELETE FROM ".$SqlTableListObj->getSQLTableName('article_config')." 

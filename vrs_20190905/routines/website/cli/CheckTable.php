...
self::$CheckTable['add']['article']['2']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_nom = '".$a['params']['config']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['article']['3']['f']	= function ($a) { if ( strlen($a['params']['creator']) == 0 ) { $a['params']['creator'] = $a['curent_user']; } return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['groupe_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE user_login = '".$a['params']['creator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['article']['4']['f']	= function ($a) { if ( strlen($a['params']['validator']) == 0 ) { $a['params']['validator'] = $a['current_user']; } return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['groupe_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['2']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_nom = '".$a['params']['config']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['link']['article']['1']['f']	= function ($a) { return array ("SELECT doc.docu_id AS docu_id, doc.docu_nom AS docu_nom FROM ".$a['sqlTables']['document']." doc , ".$a['sqlTables']['document_share']." dp WHERE doc.docu_nom = '".$a['document']."' AND dp.docu_id = doc.docu_id AND dp.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['3']['f']	= function ($a) { return array ("SELECT grp.group_name, grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg  WHERE sg.ws_id = '".$a['Context']['ws_id']."' AND grp.group_name = '".$a['params']['group_name']."' AND grp.group_id = sg.group_id;");};
...
self::$CheckTable['insert']['content']['1']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['groupe_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['creator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['insert']['content']['2']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['groupe_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document_config']['0']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_nom = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document']['1']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['groupe_user']." gu , ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['creator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document']['2']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['groupe_user']." gu , ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['document']['1']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['groupe_user']." gu , ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
self::$CheckTable['add']['group']['0']['m'] = "CLI_group_C001";

self::$CheckTable['add']['group']['1']['d'] = 2;
self::$CheckTable['add']['group']['1']['f'] = function ($a) { if ($a['params']['parent'] != 'origin' ) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['parent']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" );} else { return -1; }};
...
self::$CheckTable['update']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['group']['1']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['delete']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['module']['1']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_see']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['module']['2']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_use']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['1']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_see']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['2']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.group_name AS group_name FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.group_name = '".$a['params']['group_who_can_use']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['user']['0']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['groupe_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['name']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['user']['0']['m']	= "CLI_User_C001";
self::$CheckTable['add']['user']['1']['d']	= 2;
self::$CheckTable['add']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = 'reader' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['user']['2']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = 'anonymous' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['0']['f']	= function ($a) { return array ("SELECT usr.user_id AS user_id, usr.user_login AS user_login FROM ".$a['sqlTables']['user']." usr, ".$a['sqlTables']['groupe_user']." gu, ".$a['sqlTables']['group_website']." sg WHERE usr.user_login = '".$a['params']['name']."' AND usr.user_id = gu.user_id AND gu.group_id = sg.group_id AND gu.group_user_initial_group = '1' AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.group_name = '".$a['params']['to_group']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['2']['f']	= function ($a) { return array ( "SELECT group_user_id, group_id, user_id, group_user_initial_group FROM ".$a['sqlTables']['groupe_user']." WHERE group_id = '".$a['group_id']."' AND user_id = '".$a['user_id']."';" ); };

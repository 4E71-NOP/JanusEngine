...
self::$CheckTable['assign']['layout']['1']['f']	= function ($a) { return array ("SELECT sd.theme_id AS theme_id, sd.theme_name AS theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_name = '".$a['params']['to_theme']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['theme']['0']['m']	= "CLI_Theme_C001";

self::$CheckTable['update']['theme']['0']['d']	= 2;
self::$CheckTable['update']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_name FROM ".$a['sqlTables']['theme_descriptor']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_name = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['user']['3']['f']	= function ($a) { return array ("SELECT t.theme_id, t.theme_name FROM ".$a['sqlTables']['theme_descriptor']." t, ".$a['sqlTables']['site_theme']." st WHERE t.theme_name = '".$a['params']['pref_theme']."' AND t.theme_id = st.theme_id AND st.theme_state = '1' AND st.ws_id = '".$a['Context']['ws_id']."';");};

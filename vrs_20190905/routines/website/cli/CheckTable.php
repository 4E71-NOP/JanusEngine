...
self::$CheckTable['add']['article']['1']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['deadline']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['1']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['bouclage']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['2']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['deadline']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['3']['f']	= function ($a) { return array ("SELECT grp.groupe_nom, grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg  WHERE sg.ws_id = '".$a['Context']['ws_id']."' AND grp.groupe_nom = '".$a['params']['group_name']."' AND grp.groupe_id = sg.groupe_id;");};
...
self::$CheckTable['add']['category']['4']['f']	= function ($a) { return array ("SELECT lang_id FROM ".$a['sqlTables']['langues']." WHERE lang_639_3 = '".$a['params']['lang']."';");};
...
self::$CheckTable['add']['deadline']['0']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['deadline']['0']['m']	= "CLI_Bouclage_C001";
self::$CheckTable['update']['deadline']['0']['d']	= 2;
self::$CheckTable['update']['deadline']['0']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['deadline']['0']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['name']."' AND ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document']['2']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['groupe_user']." gu , ".$a['sqlTables']['site_groupe']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.groupe_id = sg.groupe_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['document']['1']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['groupe_user']." gu , ".$a['sqlTables']['site_groupe']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.groupe_id = sg.groupe_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
self::$CheckTable['add']['group']['0']['m'] = "CLI_group_C001";

self::$CheckTable['add']['group']['1']['d'] = 2;
self::$CheckTable['add']['group']['1']['f'] = function ($a) { if ($a['params']['parent'] != 'origin' ) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['parent']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" );} else { return -1; }};
...
self::$CheckTable['update']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['group']['1']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['delete']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['language']['1']['f']	= function ($a) { return array ( "SELECT lang_id FROM ".$a['sqlTables']['langues']." WHERE lang_639_3 = '".$a['params']['name']."'"); };
...
self::$CheckTable['add']['module']['2']['f']	= function ($a) { return array ("SELECT grp.groupe_id AS groupe_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['site_groupe']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_use']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['2']['f']	= function ($a) { return array ("SELECT grp.groupe_id AS groupe_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['site_groupe']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_use']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['translation']['0']['f']	= function ($a) { return array ( "SELECT lang_id FROM ".$a['sqlTables']['langues']." WHERE lang_639_3 = '".$a['params']['lang']."'"); };
...
self::$CheckTable['add']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = 'reader' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['user']['2']['f']	= function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = 'anonymous' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['to_group']."' AND grp.groupe_id = sg.groupe_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['website']['1']['f']	= function ($a) { return array ( "SELECT lang_id FROM ".$a['sqlTables']['langues']." WHERE lang_639_3 = '".$a['params']['lang']."'"); };
...
self::$CheckTable['update']['website']['2']['f']	= function ($a) { return array ( "SELECT lang_id FROM ".$a['sqlTables']['langues']." WHERE lang_639_3 = '".$a['params']['lang']."';"); };

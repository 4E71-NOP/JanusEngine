...
self::$CheckTable['add']['category']['3']['f']	= function ($a) { return array ("SELECT grp.groupe_nom, grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg  WHERE sg.ws_id = '".$a['Context']['ws_id']."' AND grp.groupe_nom = '".$a['params']['group_name']."' AND grp.group_id = sg.group_id;");};
...
self::$CheckTable['add']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
self::$CheckTable['add']['group']['0']['m'] = "CLI_group_C001";

self::$CheckTable['add']['group']['1']['d'] = 2;
self::$CheckTable['add']['group']['1']['f'] = function ($a) { if ($a['params']['parent'] != 'origin' ) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['parent']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" );} else { return -1; }};
...
self::$CheckTable['update']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['group']['1']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['delete']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['module']['1']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_see']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['module']['2']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_use']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['1']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_see']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['2']['f']	= function ($a) { return array ("SELECT grp.group_id AS group_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['group_website']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_use']."' AND grp.group_id = sg.group_id AND sg.ws_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = 'reader' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['user']['2']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = 'anonymous' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.group_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['group_website']." sg , ".$a['sqlTables']['website']." ws WHERE grp.groupe_nom = '".$a['params']['to_group']."' AND grp.group_id = sg.group_id AND sg.ws_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['assign']['user']['2']['f']	= function ($a) { return array ( "SELECT groupe_user_id, group_id, user_id, groupe_premier FROM ".$a['sqlTables']['groupe_user']." WHERE group_id = '".$a['group_id']."' AND user_id = '".$a['user_id']."';" ); };

...
self::$CheckTable['add']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['article']['0']['m']	= "CLI_Article_C001";
self::$CheckTable['add']['article']['1']['d']	= 2;
self::$CheckTable['add']['article']['1']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['deadline']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['article']['2']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_nom = '".$a['params']['config']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['1']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['bouclage']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['article']['2']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_nom = '".$a['params']['config']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['link']['article']['0']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['link']['article']['1']['f']	= function ($a) { return array ("SELECT doc.docu_id AS docu_id, doc.docu_nom AS docu_nom FROM ".$a['sqlTables']['document']." doc , ".$a['sqlTables']['document_share']." dp WHERE doc.docu_nom = '".$a['document']."' AND dp.docu_id = doc.docu_id AND dp.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['0']['f']	= function ($a) { return array ("SELECT cate_id FROM ".$a['sqlTables']['categorie']." WHERE site_id = '".$a['Context']['ws_id']."' AND cate_nom = '".$a['params']['name']."';");};
self::$CheckTable['add']['category']['0']['m']	= "CLI_Category_C001";
self::$CheckTable['add']['category']['1']['d']	= 1;
self::$CheckTable['add']['category']['1']['f']	= function ($a) { return array ("SELECT cate_id FROM ".$a['sqlTables']['categorie']." WHERE site_id = '".$a['Context']['ws_id']."' AND cate_nom = '".$a['params']['parent']."';");};
...
self::$CheckTable['add']['category']['2']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['deadline']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['category']['3']['f']	= function ($a) { return array ("SELECT grp.groupe_nom, grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg  WHERE sg.site_id = '".$a['Context']['ws_id']."' AND grp.groupe_nom = '".$a['params']['group_name']."' AND grp.groupe_id = sg.groupe_id;");};
...
self::$CheckTable['update']['category']['0']['f']	= function ($a) { return array ("SELECT cate_id FROM ".$a['sqlTables']['categorie']." WHERE site_id = '".$a['Context']['ws_id']."' AND cate_nom = '".$a['params']['name']."';");};
...
self::$CheckTable['add']['deadline']['0']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['deadline']['0']['m']	= "CLI_Bouclage_C001";
self::$CheckTable['update']['deadline']['0']['d']	= 2;
self::$CheckTable['update']['deadline']['0']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['deadline']['0']['f']	= function ($a) { return array ("SELECT bouclage_id FROM ".$a['sqlTables']['bouclage']." WHERE bouclage_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document_config']['0']['f']	= function ($a) { return array ("SELECT config_id FROM ".$a['sqlTables']['article_config']." WHERE config_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['document']['2']['f']	= function ($a) { return array ("SELECT usr.user_login,usr.user_id  FROM ".$a['sqlTables']['user']." usr , ".$a['sqlTables']['groupe_user']." gu , ".$a['sqlTables']['site_groupe']." sg WHERE usr.user_login = '".$a['params']['validator']."' AND usr.user_id = gu.user_id AND gu.groupe_id = sg.groupe_id AND sg.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['document']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['to_article']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
self::$CheckTable['add']['group']['0']['m'] = "CLI_group_C001";

self::$CheckTable['add']['group']['1']['d'] = 2;
self::$CheckTable['add']['group']['1']['f'] = function ($a) { if ($a['params']['parent'] != 'origin' ) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = '".$a['params']['parent']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" );} else { return -1; }};
...
self::$CheckTable['update']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['group']['1']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['delete']['group']['0']['f'] = function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = '".$a['params']['name']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['keyword']['0']['f']	= function ($a) { return array ("SELECT mc_id FROM ".$a['sqlTables']['mot_cle']." WHERE mc_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['keyword']['0']['m']	= "CLI_KeyWord_C001";
self::$CheckTable['add']['keyword']['1']['d']	= 2;
self::$CheckTable['add']['keyword']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['article']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['keyword']['0']['f']	= function ($a) { return array ("SELECT mc_id FROM ".$a['sqlTables']['mot_cle']." WHERE mc_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['keyword']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['article']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['keyword']['0']['f']	= function ($a) { return array ("SELECT mc_id FROM ".$a['sqlTables']['mot_cle']." WHERE mc_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['layout']['1']['f']	= function ($a) { return array ("SELECT sd.theme_id AS theme_id, sd.theme_nom AS theme_nom FROM ".$a['sqlTables']['theme_descripteur']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_nom = '".$a['params']['to_theme']."' AND sd.theme_id = ss.theme_id AND ss.site_id = '".$a['Context']['ws_id']."';");};
...
// self::$CheckTable['add']['layout_content']['1']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['site_module']." sm WHERE mdl.module_nom = '".$a['params']['module']."' AND mdl.module_id = sm.module_id AND sm.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['module']['0']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['site_module']." sm WHERE mdl.module_nom = '".$a['params']['name']."' AND mdl.module_id = sm.module_id AND sm.site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['module']['0']['m']	= "CLI_Module_C001";
self::$CheckTable['add']['module']['1']['d']	= 2;
self::$CheckTable['add']['module']['1']['f']	= function ($a) { return array ("SELECT grp.groupe_id AS groupe_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['site_groupe']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_see']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['module']['2']['f']	= function ($a) { return array ("SELECT grp.groupe_id AS groupe_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['site_groupe']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_use']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['0']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['site_module']." sm WHERE mdl.module_nom = '".$a['params']['name']."' AND mdl.module_id = sm.module_id AND sm.site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['update']['module']['0']['m']	= "CLI_Module_U001";
self::$CheckTable['update']['module']['1']['d']	= 2;
self::$CheckTable['update']['module']['1']['f']	= function ($a) { return array ("SELECT grp.groupe_id AS groupe_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['site_groupe']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_see']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['update']['module']['2']['f']	= function ($a) { return array ("SELECT grp.groupe_id AS groupe_id, grp.groupe_nom AS groupe_nom FROM ".$a['sqlTables']['groupe']." grp, ".$a['sqlTables']['site_groupe']." sg WHERE grp.groupe_nom = '".$a['params']['group_who_can_use']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['module']['0']['f']	= function ($a) { return array ("SELECT mdl.module_id FROM ".$a['sqlTables']['module']." mdl , ".$a['sqlTables']['site_module']." sm WHERE mdl.module_nom = '".$a['params']['name']."' AND mdl.module_id = sm.module_id AND sm.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['tag']['0']['f']	= function ($a) { return array ("SELECT tag_id,tag_nom FROM ".$a['sqlTables']['tag']." WHERE BINARY tag_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['tag']['0']['m']	= "CLI_Tag_C001";

self::$CheckTable['assign']['tag']['0']['d']	= 2;
self::$CheckTable['assign']['tag']['0']['f']	= function ($a) { return array ("SELECT tag_id,tag_nom FROM ".$a['sqlTables']['tag']." WHERE BINARY tag_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['tag']['1']['f']	= function ($a) { return array ("SELECT arti_id,arti_nom FROM ".$a['sqlTables']['article']." WHERE arti_nom = '".$a['params']['article']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['tag']['0']['f']	= function ($a) { return array ("SELECT tag_id,tag_nom FROM ".$a['sqlTables']['tag']." WHERE BINARY tag_nom = '".$a['params']['name']."' AND site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_nom FROM ".$a['sqlTables']['theme_descripteur']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_nom = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.site_id = '".$a['Context']['ws_id']."';");};
self::$CheckTable['add']['theme']['0']['m']	= "CLI_Theme_C001";

self::$CheckTable['update']['theme']['0']['d']	= 2;
self::$CheckTable['update']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_nom FROM ".$a['sqlTables']['theme_descripteur']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_nom = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['delete']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_nom FROM ".$a['sqlTables']['theme_descripteur']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_nom = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['theme']['0']['f']	= function ($a) { return array ("SELECT sd.theme_id, sd.theme_nom FROM ".$a['sqlTables']['theme_descripteur']." sd, ".$a['sqlTables']['site_theme']." ss WHERE sd.theme_nom = '".$a['params']['name']."' AND sd.theme_id = ss.theme_id AND ss.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['add']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = 'reader' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['user']['2']['f']	= function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = 'anonymous' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['update']['user']['3']['f']	= function ($a) { return array ("SELECT t.theme_id, t.theme_nom FROM ".$a['sqlTables']['theme_descripteur']." t, ".$a['sqlTables']['site_theme']." st WHERE t.theme_nom = '".$a['params']['pref_theme']."' AND t.theme_id = st.theme_id AND st.theme_etat = '1' AND st.site_id = '".$a['Context']['ws_id']."';");};
...
self::$CheckTable['assign']['user']['1']['f']	= function ($a) { return array ( "SELECT grp.groupe_id FROM ".$a['sqlTables']['groupe']." grp , ".$a['sqlTables']['site_groupe']." sg , ".$a['sqlTables']['website']." sw WHERE grp.groupe_nom = '".$a['params']['to_group']."' AND grp.groupe_id = sg.groupe_id AND sg.site_id = ws.ws_id AND ws.ws_id = '".$a['Context']['ws_id']."';" ); };
...
self::$CheckTable['add']['website']['0']['f']	= function ($a) { return array ("SELECT ws_id,ws_nom FROM ".$a['sqlTables']['website']." WHERE ws_name = '".$a['params']['name']."';");};

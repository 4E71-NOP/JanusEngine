...
self::$PreRequisiteTable['add']['theme'] = array (
		...
		"columns" => array(
				...
				array ( "v" => "name",						"t" => "theme_nom"),
				array ( "v" => "directory",					"t" => "theme_repertoire"),
				array ( "v" => "title",						"t" => "theme_titre"),
				...
				array ( "v" => "logo",						"t" => "theme_blason"),
				array ( "v" => "banner",					"t" => "theme_banniere"),
				...
				array ( "v" => "color_gradient_start",		"t" => "theme_couleur_jauge_depart"),
				array ( "v" => "color_gradient_middle",		"t" => "theme_couleur_jauge_milieu"),
				array ( "v" => "color_gradient_end",		"t" => "theme_couleur_jauge_fin"),

				array ( "v" => "block_01_name",		"t" => "theme_bloc_01_nom"),
				array ( "v" => "block_02_name",		"t" => "theme_bloc_02_nom"),
				array ( "v" => "block_03_name",		"t" => "theme_bloc_03_nom"),
				array ( "v" => "block_04_name",		"t" => "theme_bloc_04_nom"),
				array ( "v" => "block_05_name",		"t" => "theme_bloc_05_nom"),
				array ( "v" => "block_06_name",		"t" => "theme_bloc_06_nom"),
				array ( "v" => "block_07_name",		"t" => "theme_bloc_07_nom"),
				array ( "v" => "block_08_name",		"t" => "theme_bloc_08_nom"),
				array ( "v" => "block_09_name",		"t" => "theme_bloc_09_nom"),
				array ( "v" => "block_10_name",		"t" => "theme_bloc_10_nom"),
				array ( "v" => "block_11_name",		"t" => "theme_bloc_11_nom"),
				array ( "v" => "block_12_name",		"t" => "theme_bloc_12_nom"),
				array ( "v" => "block_13_name",		"t" => "theme_bloc_13_nom"),
				array ( "v" => "block_14_name",		"t" => "theme_bloc_14_nom"),
				array ( "v" => "block_15_name",		"t" => "theme_bloc_15_nom"),
				array ( "v" => "block_16_name",		"t" => "theme_bloc_16_nom"),
				array ( "v" => "block_17_name",		"t" => "theme_bloc_17_nom"),
				array ( "v" => "block_18_name",		"t" => "theme_bloc_18_nom"),
				array ( "v" => "block_19_name",		"t" => "theme_bloc_19_nom"),
				array ( "v" => "block_20_name",		"t" => "theme_bloc_20_nom"),
				array ( "v" => "block_21_name",		"t" => "theme_bloc_21_nom"),
				array ( "v" => "block_22_name",		"t" => "theme_bloc_22_nom"),
				array ( "v" => "block_23_name",		"t" => "theme_bloc_23_nom"),
				array ( "v" => "block_24_name",		"t" => "theme_bloc_24_nom"),
				array ( "v" => "block_25_name",		"t" => "theme_bloc_25_nom"),
				array ( "v" => "block_26_name",		"t" => "theme_bloc_26_nom"),
				array ( "v" => "block_27_name",		"t" => "theme_bloc_27_nom"),
				array ( "v" => "block_28_name",		"t" => "theme_bloc_28_nom"),
				array ( "v" => "block_29_name",		"t" => "theme_bloc_29_nom"),
				array ( "v" => "block_30_name",		"t" => "theme_bloc_30_nom"),
		
				array ( "v" => "block_01_text",		"t" => "theme_bloc_01_texte"),
				array ( "v" => "block_02_text",		"t" => "theme_bloc_02_texte"),
				array ( "v" => "block_03_text",		"t" => "theme_bloc_03_texte"),
				array ( "v" => "block_04_text",		"t" => "theme_bloc_04_texte"),
				array ( "v" => "block_05_text",		"t" => "theme_bloc_05_texte"),
				array ( "v" => "block_06_text",		"t" => "theme_bloc_06_texte"),
				array ( "v" => "block_07_text",		"t" => "theme_bloc_07_texte"),
				array ( "v" => "block_08_text",		"t" => "theme_bloc_08_texte"),
				array ( "v" => "block_09_text",		"t" => "theme_bloc_09_texte"),
				array ( "v" => "block_10_text",		"t" => "theme_bloc_10_texte"),
				array ( "v" => "block_11_text",		"t" => "theme_bloc_11_texte"),
				array ( "v" => "block_12_text",		"t" => "theme_bloc_12_texte"),
				array ( "v" => "block_13_text",		"t" => "theme_bloc_13_texte"),
				array ( "v" => "block_14_text",		"t" => "theme_bloc_14_texte"),
				array ( "v" => "block_15_text",		"t" => "theme_bloc_15_texte"),
				array ( "v" => "block_16_text",		"t" => "theme_bloc_16_texte"),
				array ( "v" => "block_17_text",		"t" => "theme_bloc_17_texte"),
				array ( "v" => "block_18_text",		"t" => "theme_bloc_18_texte"),
				array ( "v" => "block_19_text",		"t" => "theme_bloc_19_texte"),
				array ( "v" => "block_20_text",		"t" => "theme_bloc_20_texte"),
				array ( "v" => "block_21_text",		"t" => "theme_bloc_21_texte"),
				array ( "v" => "block_22_text",		"t" => "theme_bloc_22_texte"),
				array ( "v" => "block_23_text",		"t" => "theme_bloc_23_texte"),
				array ( "v" => "block_24_text",		"t" => "theme_bloc_24_texte"),
				array ( "v" => "block_25_text",		"t" => "theme_bloc_25_texte"),
				array ( "v" => "block_26_text",		"t" => "theme_bloc_26_texte"),
				array ( "v" => "block_27_text",		"t" => "theme_bloc_27_texte"),
				array ( "v" => "block_28_text",		"t" => "theme_bloc_28_texte"),
				array ( "v" => "block_29_text",		"t" => "theme_bloc_29_texte"),
				array ( "v" => "block_30_text",		"t" => "theme_bloc_30_texte"),
		
				array ( "v" => "block_00_menu",		"t" => "theme_bloc_00_menu"),
				array ( "v" => "block_01_menu",		"t" => "theme_bloc_01_menu"),
				array ( "v" => "block_02_menu",		"t" => "theme_bloc_02_menu"),
				array ( "v" => "block_03_menu",		"t" => "theme_bloc_03_menu"),
				array ( "v" => "block_04_menu",		"t" => "theme_bloc_04_menu"),
				array ( "v" => "block_05_menu",		"t" => "theme_bloc_05_menu"),
				array ( "v" => "block_06_menu",		"t" => "theme_bloc_06_menu"),
				array ( "v" => "block_07_menu",		"t" => "theme_bloc_07_menu"),
				array ( "v" => "block_08_menu",		"t" => "theme_bloc_08_menu"),
				array ( "v" => "block_09_menu",		"t" => "theme_bloc_09_menu"),
...
self::$PreRequisiteTable['add']['website'] = array (
		...
		"nextId" => array (
				array ("table" => "site_web",	"column" => "sw_id",		"target" => "sw_id"),
		),
		"columns" => array(
				array ( "v" => "sw_id",			"t" => "sw_id"),
				array ( "v" => "name",			"t" => "sw_nom"),
				array ( "v" => "short",			"t" => "sw_abrege"),
				array ( "v" => "lang_id",		"t" => "sw_lang"),
				array ( "v" => "lang_select",	"t" => "sw_lang_select"),
				array ( "v" => "theme_id",		"t" => "theme_id"),
				array ( "v" => "title",			"t" => "sw_titre"),
				array ( "v" => "status_bar",	"t" => "sw_barre_status"),
				array ( "v" => "home",			"t" => "sw_home"),
				array ( "v" => "directory",		"t" => "sw_repertoire"),
				array ( "v" => "state",			"t" => "sw_etat"),
				array ( "v" => "info_debug",	"t" => "sw_info_debug"),
				array ( "v" => "stylesheet",	"t" => "sw_stylesheet"),
				array ( "v" => "gal_mode",		"t" => "sw_gal_mode"),
				array ( "v" => "gal_file_tag",	"t" => "sw_gal_fichier_tag"),
				array ( "v" => "gal_quality",	"t" => "sw_gal_qualite"),
				array ( "v" => "gal_x",			"t" => "sw_gal_x"),
				array ( "v" => "gal_y",			"t" => "sw_gal_y"),
				array ( "v" => "gal_border",	"t" => "sw_gal_liserai"),
				array ( "v" => "ma_diff",		"t" => "sw_ma_diff"),
		),
);

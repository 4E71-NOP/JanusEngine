...
background-image: url(../graph/_staticPages/bg.jpg); 
...
'>
<tr>
<td style='text-align:center;'>	".$lc." <img src='../graph/_staticPages/LogoGoogleChrome.png' border='0'>		".$lz."	</td>
<td style='text-align:center;'>	".$lf." <img src='../graph/_staticPages/LogoMozillaFirefox.png' border='0'>	".$lz."	</td>
<td style='text-align:center;'>	".$li." <img src='../graph/_staticPages/LogoMicrosoftEdgeChromium.png' border='0'>		".$lz."	</td>
<td style='text-align:center;'>	".$lo." <img src='../graph/_staticPages/LogoOpera.png' border='0'>		".$lz."	</td>
</tr>
<tr>

...
// --------------------------------------------------------------------------------------------
/*Hydre-licence-fin*/
include ("routines/website/utility/Time.php");
$TimeObj = Time::getInstance();

include ("routines/website/utility/LogManagement.php");
$LMObj = LogManagement::getInstance();
$LMObj->setDebugLogEcho(1);

include ("routines/website/entity/others/UrlData.php");
$UrlDataObj = UrlData::getInstance();

include ("routines/website/utility/Mapper.php");
$MapperObj = Mapper::getInstance();

include ("routines/website/entity/dao/WebSite.php");

include ("routines/website/entity/others/ConfigurationManagement.php");
...
//
//
include ("routines/website/entity/others/ServerInfos.php");
include ("routines/website/entity/others/CurrentSet.php");
...
//
//
include ("routines/website/sddm/SddmTools.php");
include ("routines/website/sddm/DalFacade.php");
include ("routines/website/entity/others/SqlTableList.php");

$form = $UrlDataObj->getUrlData('form');
...
include ("routines/website/entity/others/ThemeData.php");
...
include ("routines/website/entity/dao/ThemeDescriptor.php");
...
include ("routines/website/entity/dao/User.php");
$CurrentSetObj->setInstanceOfUserObj(new User());
$UserObj = $CurrentSetObj->getInstanceOfUserObj();

include ("routines/website/entity/others/RenderLayout.php");
$RenderLayoutObj = RenderLayout::getInstance();

if ( !class_exists("RenderDeco40Elegance") ) { include ("routines/website/utility/RenderDeco40Elegance.php"); }
if ( !class_exists("RenderDeco50Exquisite") ) { include ("routines/website/utility/RenderDeco50Exquisite.php"); }
...
<body id='MWMbody' text='".$ThemeDataObj->getThemetBlockEntry('B01T', 'deco_txt_col')."' link='".$ThemeDataObj->getThemetBlockEntry('B01T', 'deco_txt_l_01_fg_col')."' vlink='".$ThemeDataObj->getThemetBlockEntry('B01T', 'deco_txt_l_01_fg_visite_col')."' alink='".$ThemeDataObj->getThemetBlockEntry('B01T', 'deco_txt_l_01_fg_active_col')."' background='../graph/".${$theme_tableau}['theme_repertoire']."/".${$theme_tableau}['theme_bg']."'>\r\r
";
...
$RenderLayoutObj->setLayoutModuleEntry($infos['module']['module_nom'], "dy", 512 );
...
$GeneratedJavaScriptObj->insertJavaScript('Onload', "\tGebi( 'initial_div' ).style.visibility = 'visible';");
$GeneratedJavaScriptObj->insertJavaScript('Onload', "\tGebi( 'MWMbody' ).style.visibility = 'visible';");

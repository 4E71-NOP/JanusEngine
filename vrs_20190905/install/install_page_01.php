...
$CMObj->setConfigurationEntry('admin_user','dbadmin');
$CMObj->setConfigurationEntry('admin_password','nimdabd');
$CMObj->setConfigurationEntry('db_hosting_prefix','');
...
foreach ( $LangageSelector as $A ) {
	$DocContent .= "<a href='install.php?l=".$A['code']."'><img src='../graph/".$ThemeDataObj->getThemeDataEntry('theme_repertoire')."/".$A['file']."' alt='' height='64' width='64' border='0'></a>\r";
}
$DocContent .= "</p><br>\r";
...
'../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_bas') ."', 
'../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_haut') ."', 
...
<img id='titre_cadre_".$CurrentFrame."_img' src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_haut') . "' width='32' height='32' border='0' style='vertical-align: middle;' onclick=\"animation_document_div_accordeon( '".$FrameContent.$CurrentFrame."' );\">\r
".$i18n['F1_title']."
</div>\r
<br>\r
<div id='".$FrameContent.$CurrentFrame."' style='text-align: justify; width: ".$T['tab_infos']['Width']."px; height: ".$T['tab_infos']['Height']."px; overflow: hidden;'>\r
";
...
$pv['iconGoNoGoOk'] = "<img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_ok') . "' width='16' height='16' border='0'>";
$pv['iconGoNoGoNok'] = "<img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_nok') . "' width='16' height='16' border='0'>";
...
foreach ( $Support['DAL'] as &$A ) {
	if ( file_exists ($A['file']) ) {
		...
		$F = $A['fonction'];
		$Support['response'] .= $pv['iconGoNoGoOk'] . " " . $A['name']  ." " . $i18n['PHP_builtin_ok'] . "(" . $F() . ")<br>\r";
	}
	else {
		$Support['response'] .= $pv['iconGoNoGoNok'] . " " . $pv['a'] . $A['name']  ." " . $i18n['PHP_builtin_nok'] . $pv['b'];
	}
}
if (defined('PDO::MYSQL_ATTR_LOCAL_INFILE')) { 
	$Support['response'] .= $pv['iconGoNoGoOk'] . " " . "PDO/MySQL" ." " . $i18n['PHP_builtin_ok']; 
	$Support['DAL']['PDO']['state'] = 1;
}
else { 
	$Support['response'] .= $pv['iconGoNoGoNok'] . " " . $pv['a'] . "PDO/MySQL" ." " . $i18n['PHP_builtin_nok'] . $pv['b']; 
...
$Support['response'] .= $i18n['PHP_support_titre'];

foreach ( $Support['PHP'] as &$A ) {
	if ( function_exists( $A['f'] ) ) { 
		$A['state'] = 1; 
		$Support['response'] .= $pv['iconGoNoGoOk'] . " " . $A['name']  ." " . $i18n['PHP_builtin_ok'];
	}
}
...
$T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 10;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 2;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0;
...
$CellTab['t1l5c2']	= $ServerInfosObj->getServerInfosEntry('display_errors')." / ".$i18n[$ServerInfosObj->getServerInfosEntry('register_globals')]." / ".$ServerInfosObj->getServerInfosEntry('post_max_size');
...
if ( intval(str_replace( "M", "", $ServerInfosObj->getServerInfosEntry('memory_limit') )) < 128 ) { $CellTab['t1l6c2'] .= " (<span class='".$block."_avert'>".$i18n['test_nok']."</span>)"; }	
else { $CellTab['t1l6c2'] .= " (<span class='".$block."_t3'>".$i18n['test_ok']."</span>)"; }

if ( $ServerInfosObj->getServerInfosEntry('max_execution_time') >= 60 ) { $CellTab['t1l7c2'] .= " (<span class='".$block."_avert'>".$i18n['test_nok']."</span>)"; }	
else { $CellTab['t1l7c2'] .= " (<span class='".$block."_t3'>".$i18n['test_ok']."</span>)"; }

for ( $i = 1 ; $i <= $T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] ; $i++ ) {
	$T['AD'][$CurrentTab][$i]['1']['cont'] = $i18n['t1l'.$i.'c1'];
...
$T['tab_infos']['RenderMode']		= 1;
$T['tab_infos']['HighLightType']	= 0; // 1:ligne, 2:cellule
$T['tab_infos']['Height']			= 96;
$T['tab_infos']['Width']			= $ThemeDataObj->getThemeDataEntry('theme_module_largeur_interne') -24;
$T['tab_infos']['GroupName']		= "inst1";
$T['tab_infos']['CellName']			= "cadre02";
$T['tab_infos']['DocumentName']		= "doc";
...
$bubbleBegin = "<img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_question') . "' width='16' height='16' border='0' onMouseOver=\"t.ToolTip('";
...
<br>\r
<div class='".$block."_t3' id='".$FrameContent.$CurrentFrame."' style='text-align: justify; width: ".$T['tab_infos']['Width']."px; height: ".$T['tab_infos']['Height']."px; overflow: hidden;'>\r
".$i18n['F2_intro']."\r
";

$T['AD'][$CurrentTab][$lt]['1']['cont'] = "<input type='radio' name='form[operating_mode]' onClick='setFormPreconizedSettings()' value='directCnx' checked>".$i18n['F2_m1o1'].$bubbleBegin.$i18n['F2_txt_aide1'].$bubbleEnd;
$T['AD'][$CurrentTab][$lt]['2']['cont'] = "<input type='radio' name='form[operating_mode]' onClick='setFormPreconizedSettings()' value='createScript'>".$i18n['F2_m1o2'].$bubbleBegin.$i18n['F2_txt_aide2'].$bubbleEnd;
...
$T['tab_infos']['RenderMode']		= 1;
$T['tab_infos']['HighLightType']	= 0; // 1:ligne, 2:cellule
$T['tab_infos']['Height']			= 192;
$T['tab_infos']['Width']			= $ThemeDataObj->getThemeDataEntry('theme_module_largeur_interne') -24;
$T['tab_infos']['GroupName']		= "inst1";
$T['tab_infos']['CellName']			= "cadre03";
$T['tab_infos']['DocumentName']		= "doc";
...
$CurrentTab = 1;
$lt = 1;
$T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 2;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 2;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 0;
...
<br>\r
<div id='".$FrameContent.$CurrentFrame."' style='text-align: center; width: ".$T['tab_infos']['Width']."px; height: ".$T['tab_infos']['Height']."px; overflow: hidden;'>\r
";


$T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 0;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 3;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 1;

$T['AD'][$CurrentTab]['1']['1']['cont'] = $i18n['t3l1c1'];
$T['AD'][$CurrentTab]['1']['1']['tc'] = 4;

$T['AD'][$CurrentTab]['1']['2']['cont'] = $i18n['t3l1c2'];
$T['AD'][$CurrentTab]['1']['2']['tc'] = 4;

$T['AD'][$CurrentTab]['1']['3']['cont'] = $i18n['t3l1c3'];
...
$T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 0;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 4;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 1;
$lt = 1;

$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t4l'.$lt.'c1'];	$T['AD'][$CurrentTab][$lt]['1']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['1']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['2']['cont'] = $i18n['t4l'.$lt.'c2'];	$T['AD'][$CurrentTab][$lt]['2']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['2']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['3']['cont'] = $i18n['t4l'.$lt.'c3'];	$T['AD'][$CurrentTab][$lt]['3']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['3']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t4l'.$lt.'c4'];	$T['AD'][$CurrentTab][$lt]['4']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['4']['sc'] = 1;
$lt++;

unset ($tab_);
$tab_[$CMObj->getConfigurationEntry('dal')] = " selected ";
...
if ( $Support['PHP']['PHP_mysqli_builtin']['state'] == 1 )	{ $T['AD'][$CurrentTab][$lt]['3']['cont'] .= "<option value='MYSQLI'	".$tab_['MYSQLI'].">".$i18n['msdal_msqli']."</option>\r"; }
if ( $Support['DAL']['ADOdb']['state'] == 1 )				{ $T['AD'][$CurrentTab][$lt]['3']['cont'] .= "<option value='ADODB'	".$tab_['ADODB'].">".$i18n['msdal_adodb']."</option>\r"; }
if ( $Support['DAL']['PDO']['state'] == 1 )					{ $T['AD'][$CurrentTab][$lt]['3']['cont'] .= "<option value='PHPPDO'	".$tab_['PDO'].">".$i18n['msdal_phppdo']."</option>\r"; }
if ( $Support['DAL']['pear']['state'] == 1 )					{ $T['AD'][$CurrentTab][$lt]['3']['cont'] .= "<option value='PEARDB'	".$tab_['PEARDB'].">".$i18n['msdal_pear']."</option>\r"; }

$T['AD'][$CurrentTab][$lt]['3']['cont'] .= "</select>\r";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t4l'.$lt.'c4'];
...
<option value='absolute'>".$i18n['dbp_asolute']."</option>\r
<option value='hostplan'>".$i18n['dbp_hosted']."</option>\r
</select>\r
";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t4l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
...
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='text' name='form[db_admin_user]' size='20' maxlength='32' value='".$CMObj->getConfigurationEntry('admin_user')."'  class='" . $block."_form_1'>";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t4l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
$lt++;
...
$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t4l'.$lt.'c1'];
$T['AD'][$CurrentTab][$lt]['2']['cont'] = $i18n['t4l'.$lt.'c2'];
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='password' name='form[db_admin_password]' size='20' maxlength='32' value='".$CMObj->getConfigurationEntry('admin_password')."'  class='" . $block."_form_1'>";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t4l'.$lt.'c4'];
$lt++;
...
$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t4l'.$lt.'c1'];	$T['AD'][$CurrentTab][$lt]['1']['tc'] = 2;
...
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $pv['div_cnx_db'] . "
	<div id='TstBDD_1_ok' style='visibilty: hidden; display : none; position; realtive;'><img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_ok') . "' width='16' height='16' border='0'>".$i18n['t4l10c4aok']."</div>
	<div id='TstBDD_1_ko' style='visibilty: hidden; display : none; position; realtive;'><img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_nok') . "' width='16' height='16' border='0'>".$i18n['t4l10c4ako']."</div>
	<div id='TstBDD_2_ok' style='visibilty: hidden; display : none; position; realtive;'><img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_ok') . "' width='16' height='16' border='0'>".$i18n['t4l10c4bok']."</div>
	<div id='TstBDD_2_ko' style='visibilty: hidden; display : none; position; realtive;'><img src='../graph/" . $ThemeDataObj->getThemeDataEntry('theme_repertoire') . "/" . $ThemeDataObj->getThemeBlockEntry($infos['blockT'], 'icone_nok') . "' width='16' height='16' border='0'>".$i18n['t4l10c4bko']."</div>
	";

$T['AD'][$CurrentTab][$lt]['4']['tc'] = 2;
$T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = $lt;
$DocContent .= $RenderTablesObj->render($infos, $T)."</div>\r";
...
$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t5l'.$lt.'c1'];	$T['AD'][$CurrentTab][$lt]['1']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['1']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['2']['cont'] = $i18n['t5l'.$lt.'c2'];	$T['AD'][$CurrentTab][$lt]['2']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['2']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['3']['cont'] = $i18n['t5l'.$lt.'c3'];	$T['AD'][$CurrentTab][$lt]['3']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['3']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];	$T['AD'][$CurrentTab][$lt]['4']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['4']['sc'] = 1;
$lt++;

$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t5l'.$lt.'c1'];
$T['AD'][$CurrentTab][$lt]['2']['cont'] = "<input type='text' name='form[tabprefix]' size='10' maxlength='32' value='".$CMObj->getConfigurationEntry('tabprefix')."' OnKeyup=\"InsereValeur ( 'Ex: ' + this.value + 'article_config' , '".$FormName."', ['form[db_hosting_tabprefix_copie_1]'] );\"  class='" . $block."_form_1'>";
...
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
$GeneratedJavaScriptObj->insertJavaScript('Command' , "InsereValeur ( 'Ex: ".$CMObj->getConfigurationEntry('tabprefix')."article_config' , '".$FormName."', ['form[db_hosting_tabprefix_copie_1]' , 'form[db_hosting_tabprefix_copie_1]' ] );");
...
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='text' name='form[database_user_login]' size='20' maxlength='32' value='".$CMObj->getConfigurationEntry('db_user_login')."'  class='" . $block."_form_1'>";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
$lt++;
...
$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t5l'.$lt.'c1'];
$T['AD'][$CurrentTab][$lt]['2']['cont'] = $i18n['t5l'.$lt.'c2'];
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='password' id='form[database_user_password]' name='form[database_user_password]' size='20' maxlength='32' value='".$CMObj->getConfigurationEntry('db_user_password')."'  class='" . $block."_form_1'>";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'] . "<br><br>". $InteractiveElementsObj->renderSubmitButton($SB);
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
$lt++;
...
<option value='non'>".$i18n['dbr_n']."</option>\r
<option value='oui' selected >".$i18n['dbr_o']."</option>\r
</select>\r
";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
...
$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t5l'.$lt.'c1'];
$T['AD'][$CurrentTab][$lt]['2']['cont'] = $i18n['t5l'.$lt.'c2'];
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='password' name='form[standard_user_password]' size='20' maxlength='32' value='".$CMObj->getConfigurationEntry('db_user_password')."'  class='" . $block."_form_1'>";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
$lt++;
...
<option value='non' selected>".$i18n['dbr_n']."</option>\r
<option value='oui'>".$i18n['dbr_o']."</option>\r
</select>\r
";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
...
<option value='ModuleApache' selected>".$i18n['TypeExec1']."</option>\r
<option value='CLI'>".$i18n['TypeExec2']."</option>\r
</select>\r
";
$T['AD'][$CurrentTab][$lt]['4']['cont'] = $i18n['t5l'.$lt.'c4'];
$T['AD'][$CurrentTab][$lt]['4']['tc'] = 1;
...
$CurrentTab = 1;
$lt = 1;
$T['ADC']['onglet'][$CurrentTab]['nbr_ligne'] = 3;	$T['ADC']['onglet'][$CurrentTab]['nbr_cellule'] = 3;	$T['ADC']['onglet'][$CurrentTab]['legende'] = 1;
...
$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t6l'.$lt.'c1'];	$T['AD'][$CurrentTab][$lt]['1']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['1']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['2']['cont'] = $i18n['t6l'.$lt.'c2'];	$T['AD'][$CurrentTab][$lt]['2']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['2']['sc'] = 1;
$T['AD'][$CurrentTab][$lt]['3']['cont'] = $i18n['t6l'.$lt.'c3'];	$T['AD'][$CurrentTab][$lt]['3']['tc'] = 4;	$T['AD'][$CurrentTab][$lt]['3']['sc'] = 1;
$lt++;

$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t6l'.$lt.'c1'];
$T['AD'][$CurrentTab][$lt]['2']['cont'] = "<input type='checkbox' name='form[db_detail_log_warn]'>" . $i18n['t6l'.$lt.'c2'];
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='checkbox' name='form[db_detail_log_err]' checked>" . $i18n['t6l'.$lt.'c3'];
$lt++;


$T['AD'][$CurrentTab][$lt]['1']['cont'] = $i18n['t6l'.$lt.'c1'];
$T['AD'][$CurrentTab][$lt]['2']['cont'] = "<input type='checkbox' name='form[console_detail_log_warn]' checked>" . $i18n['t6l'.$lt.'c2'];
$T['AD'][$CurrentTab][$lt]['3']['cont'] = "<input type='checkbox' name='form[console_detail_log_err]' checked>" . $i18n['t6l'.$lt.'c3'];
$lt++;
...
// --------------------------------------------------------------------------------------------
$pv['ListeChamps']['0']['id'] = 'form[host]';					$pv['ListeChamps']['0']['name'] = $i18n['ls0'];	$pv['ListeChamps']['0']['err'] = 0;
$pv['ListeChamps']['1']['id'] = 'form[db_admin_user]';			$pv['ListeChamps']['1']['name'] = $i18n['ls1'];	$pv['ListeChamps']['1']['err'] = 0;
$pv['ListeChamps']['2']['id'] = 'form[db_admin_password]';		$pv['ListeChamps']['2']['name'] = $i18n['ls2'];	$pv['ListeChamps']['2']['err'] = 0;
$pv['ListeChamps']['3']['id'] = 'form[dbprefix]';				$pv['ListeChamps']['3']['name'] = $i18n['ls3'];	$pv['ListeChamps']['3']['err'] = 0;
$pv['ListeChamps']['4']['id'] = 'form[database_user_login]';	$pv['ListeChamps']['4']['name'] = $i18n['ls4'];	$pv['ListeChamps']['4']['err'] = 0;
$pv['ListeChamps']['5']['id'] = 'form[database_user_password]';	$pv['ListeChamps']['5']['name'] = $i18n['ls5'];	$pv['ListeChamps']['5']['err'] = 0;
$pv['ListeChamps']['6']['id'] = 'form[standard_user_password]';	$pv['ListeChamps']['6']['name'] = $i18n['ls6'];	$pv['ListeChamps']['6']['err'] = 0;
...
$GeneratedJavaScriptObj->insertJavaScript('Data' , " var AlertVerifieChampsFomulaire = '". $i18n['avcf'] ."'");

// --------------------------------------------------------------------------------------------

$SessionID = floor ( $TimeObj->microtime_chrono() );

...
$GAL_mode_select[$site_web['sw_gal_mode']]['s'] = " selected ";
foreach ( $GAL_mode_select as $A ) { echo ("<option value='".$A['cmd']."' ".$A['s']."> ".$A['t']."</option>\r"); }
echo ("
</select>\r
</td></tr>\r

<tr><td class='" . $theme_tableau.$_REQUEST['bloc']."_fcc " . $theme_tableau.$_REQUEST['bloc']."_t3'>".$tl_[$l]['d5_01']."</td>	<td class='" . $theme_tableau.$_REQUEST['bloc']."_fcd " . $theme_tableau.$_REQUEST['bloc']."_t3'>&lt;nom de fichier&gt;<input type='text' name='MSW[gal_fichier_tag]' size='20' maxlength='255' value='".$site_web['sw_gal_fichier_tag']."' class='" . $theme_tableau.$_REQUEST['bloc']."_form_1'></td></tr>\r
<tr><td class='" . $theme_tableau.$_REQUEST['bloc']."_fcc " . $theme_tableau.$_REQUEST['bloc']."_t3'>".$tl_[$l]['d5_02']."</td>	<td class='" . $theme_tableau.$_REQUEST['bloc']."_fcd " . $theme_tableau.$_REQUEST['bloc']."_t3'><input type='text' name='MSW[gal_qualite]' size='20' maxlength='255' value='".$site_web['sw_gal_qualite']."' class='" . $theme_tableau.$_REQUEST['bloc']."_form_1'>%</td></tr>\r
<tr><td class='" . $theme_tableau.$_REQUEST['bloc']."_fcc " . $theme_tableau.$_REQUEST['bloc']."_t3'>".$tl_[$l]['d5_03']."</td>	<td class='" . $theme_tableau.$_REQUEST['bloc']."_fcd " . $theme_tableau.$_REQUEST['bloc']."_t3'><input type='text' name='MSW[gal_x]' size='20' maxlength='255' value='".$site_web['sw_gal_x']."' class='" . $theme_tableau.$_REQUEST['bloc']."_form_1'>pixels</td></tr>\r
<tr><td class='" . $theme_tableau.$_REQUEST['bloc']."_fcc " . $theme_tableau.$_REQUEST['bloc']."_t3'>".$tl_[$l]['d5_04']."</td>	<td class='" . $theme_tableau.$_REQUEST['bloc']."_fcd " . $theme_tableau.$_REQUEST['bloc']."_t3'><input type='text' name='MSW[gal_y]' size='20' maxlength='255' value='".$site_web['sw_gal_y']."' class='" . $theme_tableau.$_REQUEST['bloc']."_form_1'>pixels</td></tr>\r
<tr><td class='" . $theme_tableau.$_REQUEST['bloc']."_fcc " . $theme_tableau.$_REQUEST['bloc']."_t3'>".$tl_[$l]['d5_05']."</td>	<td class='" . $theme_tableau.$_REQUEST['bloc']."_fcd " . $theme_tableau.$_REQUEST['bloc']."_t3'><input type='text' name='MSW[gal_liserai]' size='20' maxlength='255' value='".$site_web['sw_gal_liserai']."' class='" . $theme_tableau.$_REQUEST['bloc']."_form_1'>pixels</td></tr>\r
</table>\r
</div>\r
");
$pv['div_compteur']++;

...
if ( $_REQUEST['C_GALERI']['update'] == 1 ) {
	...
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['mode']."'				WHERE extension_variable = 'mode'			AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['qualite']."'			WHERE extension_variable = 'qualite'		AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['x']."'				WHERE extension_variable = 'x'				AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['y']."'				WHERE extension_variable = 'y'				AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['liserai']."'			WHERE extension_variable = 'liserai'		AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['table_colonnes']."'	WHERE extension_variable = 'table_colonnes'	AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['table_lignes']."'		WHERE extension_variable = 'table_lignes'	AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	$requete[] = "UPDATE ".$SQL_tab_abrege['extension_config']." SET extension_valeur = '".$_REQUEST['C_GALERI']['fichier_tag']."'		WHERE extension_variable = 'fichier_tag'	AND site_id = '".$site_web['sw_id']."' AND extension_id =  '".$_REQUEST['C_GALERI']['extension_id']."'";
	unset ( $A );
	...
	WHERE exc.site_id = '".$site_web['sw_id']."' 

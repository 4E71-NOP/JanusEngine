...
if ($_REQUEST['C_GALERI']['update'] == 1) {
	...
	foreach ($requete as $A) {
		manipulation_traitement_requete($A);
	}
} else {
	...
	while ($dbp = fetch_array_sql($dbquery)) {
		$_REQUEST['C_GALERI'][$dbp['extension_variable']] = $dbp['extension_value'];
	}
}


$tl_['eng']['o1_l1'] = "Storage";
$tl_['fra']['o1_l1'] = "Stockage";
$tl_['eng']['o1_l2'] = "Quality";
$tl_['fra']['o1_l2'] = "Qualit&eacute;";
$tl_['eng']['o1_l3'] = "Max width";
$tl_['fra']['o1_l3'] = "Largeur maximum";
$tl_['eng']['o1_l4'] = "Max height";
$tl_['fra']['o1_l4'] = "Hauteur maximum";
$tl_['eng']['o1_l5'] = "Border width";
$tl_['fra']['o1_l5'] = "&eacute;paisseur liserai";
$tl_['eng']['o1_l6'] = "File tag";
$tl_['fra']['o1_l6'] = "Marquage fichier";
...
$tl_['eng']['selectmode']['0'] = "Live mode";
$tl_['fra']['selectmode']['0'] = "Pas de stockage";
$tl_['eng']['selectmode']['1'] = "Store in database";
$tl_['fra']['selectmode']['1'] = "Stockage en base de donn&eacute;e";
$tl_['eng']['selectmode']['2'] = "Store in files";
$tl_['fra']['selectmode']['2'] = "Stockage dans des fichiers";

$AD['1']['1']['2']['cont'] = "<select name='GG[mode]' class='" . $theme_tableau . $_REQUEST['bloc'] . "_form_1 " . $theme_tableau . $_REQUEST['bloc'] . "_t2'>\r";
$GAL_mode_select['0']['t'] = $tl_[$l]['selectmode']['0'];
$GAL_mode_select['0']['s'] = "";
$GAL_mode_select['0']['cmd'] = "0";
$GAL_mode_select['1']['t'] = $tl_[$l]['selectmode']['1'];
$GAL_mode_select['1']['s'] = "";
$GAL_mode_select['1']['cmd'] = "1";
$GAL_mode_select['2']['t'] = $tl_[$l]['selectmode']['2'];
$GAL_mode_select['2']['s'] = "";
$GAL_mode_select['2']['cmd'] = "2";
$GAL_mode_select[$_REQUEST['C_GALERI']['mode']]['s'] = " selected ";
foreach ($GAL_mode_select as $A) {
	$AD['1']['1']['2']['cont'] .= "<option value='" . $A['cmd'] . "' " . $A['s'] . "> " . $A['t'] . "</option>\r";
}
...
$tl_['eng']['onglet1'] = "Gallery";
$tl_['fra']['onglet1'] = "Galerie";
$ADC['tabs']['1']['NbrOfLines'] = 6;
...
$tl_['eng']['bouton_config1'] = "Modify";
$tl_['fra']['bouton_config1'] = "Modifier";
...
$GAL_taille_nom = 24;
$GAL_nom = "Example";
$GAL_dir = "../websites-datas/www.rootwave.net/data/document/fra_gallerie_photographie_p01";
